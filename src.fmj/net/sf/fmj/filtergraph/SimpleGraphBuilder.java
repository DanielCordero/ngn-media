...
public class SimpleGraphBuilder {
	 ...
	 * 
	 * @param outs
	 *            the supported output formats from the upstream node.
	 * @param ins
	 *            the supported input formats from the downstream node.
	 * @param up
	 *            the upstream node.
	 * @param down
	 *            the downstream node.
	...
	protected boolean setDefaultTargetRenderer(Format in) {
		...
		if (in instanceof AudioFormat) {
			targetPluginNames = PlugInManager.getPlugInList(new AudioFormat(null, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, null), null, PlugInManager.RENDERER);
		} else if (in instanceof VideoFormat) {
			targetPluginNames = PlugInManager.getPlugInList(new VideoFormat(null, null, Format.NOT_SPECIFIED, null, Format.NOT_SPECIFIED // frameRate
																																			// ???
