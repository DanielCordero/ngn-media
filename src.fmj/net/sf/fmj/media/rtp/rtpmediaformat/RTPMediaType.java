...
/**
 * The <tt>RTPMediaType</tt> enumeration contains a list of media types
...
public enum RTPMediaType
{
     ...
     * create.
     */
    private RTPMediaType(String mediaTypeName)
    {
     ...
     */
    public static RTPMediaType parseString(String mediaTypeName)
