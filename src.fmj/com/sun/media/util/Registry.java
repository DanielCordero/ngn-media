...
public class Registry {
	 ...
	 * 
	 * @param key
	 *            the key whose associated value is to be returned in the form
	 *            of a <tt>boolean</tt>
	 * @param defaultValue
	 *            a <tt>boolean</tt> value to be returned if no value is
	 *            associated with the specified <tt>key</tt>
	 * @return a <tt>boolean</tt> representation of the value associated with
	 *         the specified <tt>key</tt> if such an association exists and it
	 *         is possible to parse the value as a <tt>boolean</tt>; otherwise,
	 *         <tt>defaultValue</tt>
	 */
	 ...
	 *            of an <tt>int</tt>
	 * @param defaultValue
	 *            an <tt>int</tt> value to be returned if no value is associated
	 *            with the specified <tt>key</tt>
