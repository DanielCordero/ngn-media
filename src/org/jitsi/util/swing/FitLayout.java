...
public class FitLayout implements LayoutManager {
	...
	protected void layoutComponent(Component component, Rectangle bounds, float alignmentX, float alignmentY) {
		...
		/*
		 * If the specified component does not have a preferredSize, we cannot
		 * know its aspect ratio and we are left with no choice but to stretch
		 * it within the complete bounds.
		 */
		...
		component.setBounds(bounds.x + Math.round((bounds.width - size.width) * alignmentX), bounds.y + Math.round((bounds.height - size.height) * alignmentY), size.width, size.height);
	}
	...
	protected void layoutContainer(Container parent, float componentAlignmentX) {
		...
		if (component != null) {
			layoutComponent(component, new Rectangle(parent.getSize()), componentAlignmentX, Component.CENTER_ALIGNMENT);
		}
	}
	...
	public Dimension minimumLayoutSize(Container parent) {
		...
		return (component != null) ? component.getMinimumSize() : new Dimension(DEFAULT_HEIGHT_OR_WIDTH, DEFAULT_HEIGHT_OR_WIDTH);
	}
	...
	public Dimension preferredLayoutSize(Container parent) {
		...
		return (component != null) ? component.getPreferredSize() : new Dimension(DEFAULT_HEIGHT_OR_WIDTH, DEFAULT_HEIGHT_OR_WIDTH);
	}
