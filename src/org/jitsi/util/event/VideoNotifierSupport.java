...
public class VideoNotifierSupport {
	 ...
	 * 
	 * @param source
	 *            the <tt>Object</tt> which is to be reported as the source of
	 *            the <tt>VideoEvent</tt>s fired by the new instance
	 */
	 ...
	 *            the <tt>VideoEvent</tt>s fired by the new instance
	 * @param synchronous
	 *            <tt>true</tt> if the new instance is to deliver the
