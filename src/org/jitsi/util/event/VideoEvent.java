...
public class VideoEvent extends EventObject {
	 ...
	 * 
	 * @param source
	 *            the source of the new <tt>VideoEvent</tt> and the provider of
	 ...
	 *            the visual <tt>Component</tt> depicting video which had its
	 *            availability in the <tt>source</tt> provider changed
	 * @param origin
	 ...
	 *         the same property values as this instance except for the source
	 *         which is set on the new instance to the specified <tt>source</tt>
	 */
	 ...
	 *         representation of the specified <tt>VideoEvent</tt>
	 *         <tt>origin</tt> constant
	 */
