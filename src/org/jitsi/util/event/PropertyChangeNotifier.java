...
public class PropertyChangeNotifier {
	 ...
	 *            <tt>PropertyChangeNotifier</tt>. If the specified listener is
	 ...
	 *         <tt>PropertyChangeEvent</tt> which is to notify the
	 *         <tt>PropertyChangeListener</tt>s registered with this
	 *         <tt>PropertyChangeNotifier</tt> about the change in the value of
	 *         the property with the specified name from the specified old value
