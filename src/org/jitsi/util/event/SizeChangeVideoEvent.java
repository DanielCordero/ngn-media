...
public class SizeChangeVideoEvent extends VideoEvent {
	 ...
	 * 
	 * @param source
	 *            the source of the new <tt>SizeChangeVideoEvent</tt>
	 * @param visualComponent
	 *            the visual <tt>Component</tt> depicting video with the updated
	 *            size
	 * @param origin
	 *            the origin of the video the new <tt>SizeChangeVideoEvent</tt>
	 *            is to notify about
	 * @param width
	 *            the new width of <tt>visualComponent</tt>
	 * @param height
	 *            the new height of <tt>visualComponent</tt>
	 */
