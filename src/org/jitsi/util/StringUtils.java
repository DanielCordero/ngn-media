...
public final class StringUtils {
	 ...
	 * 
	 * @param camelCase
	 *            a camel-case (or Pascal-case) formatted <tt>String</tt> from
	 *            which a human-readable <tt>String</tt> is to be constructed
	 * @return a <tt>String</tt> which represents the conversion of the
	 *         specified camel-case formatted <tt>String</tt> to a more
	 *         human-readable form
	 */
	 ...
	 *            with the second
	 * @param s2
	 *            the second <tt>String</tt> value to check for value equality
	 *            with the first
	 ...
	 * 
	 * @param string
	 *            the <tt>String</tt> whose bytes we'd like to obtain.
	 ...
	 * 
	 * @param bytes
	 *            the <tt>byte</tt> array that we'd like to convert into a
	 *            <tt>String</tt>.
	 ...
	 * 
	 * @param string
	 *            the string to check for letters
	 ...
	 * 
	 * @param bytes
	 *            the bytes to be decoded into characters/a new <tt>String</tt>
	 *            instance
