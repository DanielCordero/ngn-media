...
public class Logger {
	 ...
	 * 
	 * @param logger
	 *            the implementation specific logger delegate that this Logger
	 *            instance should be created around.
	 */
	...
	/**
	 * Find or create a logger for the specified class. If a logger has already
	 * been created for that class it is returned. Otherwise a new logger is
	 * created.
	 * <p>
	 * If a new logger is created its log level will be configured based on the
	 * logging configuration and it will be configured to also send logging
	 ...
	 *            should normally be based on the class name of the creator,
	 *            such as "net.java.sip.communicator.MyFunnyClass"
	 *            <p>
	 * @return a suitable Logger
	 * @throws NullPointerException
	 *             if the name is null.
	 ...
	 * Log a TRACE message.
	 * <p>
	 * If the logger is currently enabled for the TRACE message level then the
	 ...
	 * used at startup. So if the properties containing the log dir locations
	 * have changed, we would read the new configuration.
	 */
	public void reset() {
		try {
