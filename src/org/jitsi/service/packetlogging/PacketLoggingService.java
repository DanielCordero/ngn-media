...
/**
 * A Packet Logging Service to log packets that were send/received by protocols
 * or any other network related services in various formats. Its for debugging
 * purposes.
 * 
...
public interface PacketLoggingService {
	...
	/**
	 * Checks is logging globally enabled for and is it currently available fo
	 * the given protocol. .
	 * 
	 * @param protocol
	 *            that is checked.
	 ...
	 * 
	 * @param protocol
	 *            the source protocol that logs this packet.
	 * @param sourceAddress
	 ...
	 * @param transport
	 *            the transport this packet uses.
	 * @param sender
	 *            are we the sender of the packet or not.
	 * @param packetContent
	 *            the packet content.
	 */
