...
/**
 * The Resource Management Service gives easy access to common resources for the
 * application including texts, images, sounds and some configurations.
 * 
...
public interface ResourceManagementService {
	 ...
	 * 
	 * @param key
	 *            The key of the color in the colors properties file.
	 ...
	 * 
	 * @param streamKey
	 *            The identifier of the image in the resource properties file.
	 * @return the <tt>InputStream</tt> of the image corresponding to the given
	 *         key.
	 */
	 ...
	 */
	public final static String DEFAULT_LOCALE_CONFIG = "net.java.sip.communicator.service.resources.DefaultLocale";
	 ...
	 * 
	 * @param key
	 *            The identifier of the string in the resources properties file.
	 ...
	 *            The identifier of the string in the resources properties file.
	 * @param params
	 *            An array of parameters to be replaced in the returned string.
	 * @return An internationalized string corresponding to the given key and
	 *         given locale.
	 */
	...
	/**
	 * Returns an url for the setting corresponding to the given key. Used when
	 * the setting is an actual file.
	 * 
	 * @param urlKey
	 ...
	 * @param resourceClass
	 *            the resource class through which the resource would be
	 *            obtained
	...
	/**
	 * Loads the image with the specified ID and returns a byte array containing
	 * it.
	 * 
	 * @param imageID
	 *            The identifier of the image.
	 ...
	 * 
	 * @param zipFile
	 *            Zip file with skin information.
