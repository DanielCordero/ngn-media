...
/**
 * The <tt>CallPeerSecurityFailedEvent</tt> is triggered whenever a problem has
 * occurred during call security process.
 * 
...
public class CallPeerSecurityMessageEvent extends EventObject {
	...
	/**
	 * Creates a <tt>CallPeerSecurityFailedEvent</tt> by specifying the call
	 * peer, event type and message associated with this event.
	 * 
	 * @param source
	 ...
	 *            the message associated with this event.
	 * @param i18nMessage
	 *            the internationalized message associated with this event that
