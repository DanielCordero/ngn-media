...
public class OperationFailedException extends Exception {
	...
	/**
	 * Set when command fails due to a failure in network communications or a
	 * transport error.
	 */
	public static final int NETWORK_FAILURE = 2;

	/**
	 * Set to indicate that a provider needs to be registered or signed on a
	 * public service before calling the method that threw the exception.
	 */
	...
	/**
	 * Indicates that the exception was thrown because a method has been passed
	 ...
	 *            exception
	 * @param errorCode
	 *            the error code of the exception (one of the error code fields
	 *            of this class)
	 */
