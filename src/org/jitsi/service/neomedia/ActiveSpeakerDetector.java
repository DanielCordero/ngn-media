...
public interface ActiveSpeakerDetector {
	 ...
	 * 
	 * @param listener
	 *            the listener to register with this instance for notifications
	 ...
	 * 
	 * @param ssrc
	 *            the SSRC of the stream/speaker
	 * @param level
	 *            the latest/current audio level of the stream/speaker with the
