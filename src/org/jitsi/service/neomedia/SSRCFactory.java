...
public interface SSRCFactory {
	 ...
	 * 
	 * @param cause
	 *            a <tt>String</tt> which specified the cause of the invocation
	 *            of the method
	 * @return a randomly chosen <tt>int</tt> value which is to be utilized as a
	 *         new synchronization source (SSRC) identifier should it be found
	 *         to be globally unique within the associated RTP session or
	 *         <tt>Long.MAX_VALUE</tt> if this <tt>SSRCFactory</tt> has
