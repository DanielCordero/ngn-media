...
public interface KeyFrameControl {
	 ...
	 * 
	 * @param index
	 *            the zero-based index at which <tt>keyFrameRequestee</tt> is to
	 *            be added to the list of <tt>KeyFrameRequestee</tt>s made
	 *            available or <tt>-1</tt> to have this <tt>KeyFrameControl</tt>
	 *            choose at which index it is to be added in accord with its
	 *            internal logic through this <tt>KeyFrameControl</tt>
	 * @param keyFrameRequestee
	 *            the <tt>KeyFrameRequestee</tt> to be added to this
	 *            <tt>KeyFrameControl</tt> so that it is made available through
	 *            it
	 */
	 ...
	 * 
	 * @param index
	 *            the zero-based index at which <tt>keyFrameRequester</tt> is to
	 *            be added to the list of <tt>KeyFrameRequester</tt>s made
	 *            available or <tt>-1</tt> to have this <tt>KeyFrameControl</tt>
	 *            choose at which index it is to be added in accord with its
	 *            internal logic through this <tt>KeyFrameControl</tt>
	 * @param keyFrameRequester
	 *            the <tt>KeyFrameRequester</tt> to be added to this
	 *            <tt>KeyFrameControl</tt> so that it is made available through
	 *            it
	 */
	 ...
	 * 
	 * @param keyFrameRequestee
	 *            the <tt>KeyFrameRequestee</tt> to be removed from this
	 *            <tt>KeyFrameControl</tt> so that it is no longer made
	 ...
	 * 
	 * @param keyFrameRequester
	 *            the <tt>KeyFrameRequester</tt> to be removed from this
	 *            <tt>KeyFrameControl</tt> so that it is no longer made
	 *            available through it
	 ...
	 * 
	 * @param urgent
	 *            <tt>true</tt> if the caller has determined that the need for a
	 *            key frame is urgent and should not obey all constraints with
	 ...
	 *         peer of the associated <tt>VideoMediaStream</tt> in response to
	...
	public interface KeyFrameRequester {
		 ...
		 * <tt>ConfigurationService</tt> property which indicates that the RTCP
		 * <tt>KeyFrameRequester</tt> is preferred.
		 */
