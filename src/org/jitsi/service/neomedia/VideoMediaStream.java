...
/**
 * Extends the <tt>MediaStream</tt> interface and adds methods specific to video
 * streaming.
 * 
 * @author Emil Ivov
...
public interface VideoMediaStream extends MediaStream {
	 ...
	 *             and rendered, it is not clear which one of them is to be
	 *             singled out as the return value. Thus
	 *             {@link #getVisualComponent(long)} and
	 ...
	 * 
	 * @param ssrc
	 *            the SSRC of the <tt>ReceiveStream</tt> to get the associated
