...
public class MediaStreamTarget {
	...
	/**
	 * Initializes a new <tt>MediaStreamTarget</tt> instance with specific RTP
	 * and RTCP <tt>InetSocketAddress<tt>es.
	 * 
	 * @param rtpTarget
	 *            the <tt>InetSocketAddress</tt> that the new instance is to
	 *            indicate as a data/RTP address.
	 * @param rtcpTarget
	 *            the <tt>InetSocketAddress</tt> that the new instance is to
	 *            indicate as a control/RTCP address.
	 */
	...
	/**
	 * Initializes a new <tt>MediaStreamTarget</tt> instance with specific RTP
	 * and RTCP <tt>InetAddress</tt>es and ports.
	 * 
	 * @param rtpAddr
	 *            the <tt>InetAddress</tt> that the new instance is to indicate
	 *            as the IP address of a data/RTP address
	 * @param rtpPort
	 *            the port that the new instance is to indicate as the port of a
	 *            data/RTP address
	 * @param rtcpAddr
	 *            the <tt>InetAddress</tt> that the new instance is to indicate
	 *            as the IP address of a control/RTCP address
	 * @param rtcpPort
	 *            the port that the new instance is to indicate as the port of a
	 ...
	 * 
	 * @param addr1
	 *            one of the <tt>InetSocketAddress</tt> instances to be compared
	 * @param addr2
