...
public interface QualityControl {
	 ...
	 * But will have on next media changes. With this we can try to change the
	 * resolution that the remote part is sending.
	 * 
	 * @param preset
	...
	/**
	 * Changes remote send preset and protocols who can handle the changes will
	 * implement this for re-inviting the other party or just sending that media
	 * has changed.
	 * 
	 * @param preset
	 *            the new preset.
