...
public interface MediaStream {
	 ...
	 * @param overloadPt
	 *            the payload type that we are overriging it with
	 */
	 ...
	 * 
	 * @param extensionID
	 *            the ID that is mapped to <tt>rtpExtension</tt> for the
	 *            lifetime of this <tt>MediaStream</tt>.
	 * @param rtpExtension
	 ...
	 *         participant or <tt>-1</tt> if that identifier is not yet known at
	 *         this point.
	 */
	...
	/**
	 * Returns the name of this stream or <tt>null</tt> if no name has been set.
	 * A stream name is used by some protocols, for diagnostic purposes mostly.
	 * In XMPP for example this is the name of the content element that
	 * describes a stream.
	 * 
	...
	/**
	 * Gets the value of a specific opaque property of this <tt>MediaStream</tt>
	 * .
	 * 
	 * @param propertyName
	 *            the name of the opaque property of this <tt>MediaStream</tt>
	 ...
	 *         or <tt>-1</tt> if that identifier is not yet known at this point
	 *         in the execution
	 */
	 ...
	 * 
	 * @param listener
	 *            the listener that we'd like to remove.
	 */
	 ...
	 * 
	 * @param ssrc
	 *            the SSRC for which to remove a <tt>ReceiveStream</tt>
	 */
	 ...
	 * 
	 * @param connector
	 *            the <tt>StreamConnector</tt> to be used by this
	 ...
	 * 
	 * @param mute
	 *            <tt>true</tt> if we are to start transmitting "silence" and
	 ...
	 * 
	 * @param name
	 *            the name of this stream or <tt>null</tt> if no name has been
	 *            set.
	 */
	public void setName(String name);

	/**
	 * Sets the value of a specific opaque property of this <tt>MediaStream</tt>
	 * .
	 * 
	 * @param propertyName
	 *            the name of the opaque property of this <tt>MediaStream</tt>
	 *            the value of which is to be set to the specified
	 *            <tt>value</tt>
	 * @param value
	 *            the value of the opaque property of this <tt>MediaStrea</tt>
	...
	/**
	 * Sets the ID of the abs-send-time RTP header extension to be used by this
	 * <tt>MediaStream</tt>.
	 * 
	 * If set to a value different than -1, any outgoing RTP packets that
	 * already contain an RTP extension with this ID will have the timestamp in
	 * said extension replaced with one generated locally at (close to) the time
	 * of transmission.
	 * 
