...
public class RecorderEvent {
	...
	/**
	 * An NTP timestamp (represented as a double in seconds) for this
	 * <tt>RecorderEvent</tt>.
	 */
	 ...
	 */
	private RTPMediaType mediaType = null;
	...
	public void setMediaType(RTPMediaType mediaType) {
	...
	public enum Type {
		...
		/**
		 * Indicates that the active speaker has changed. The 'audioSsrc' field
		 * indicates the SSRC of the audio stream which is now considered
	...
	public enum AspectRatio {
		ASPECT_RATIO_16_9("16_9", 16. / 9), ASPECT_RATIO_4_3("4_3", 4. / 3), ASPECT_RATIO_UNKNOWN("UNKNOWN", 1.);
