...
/**
 * webrtc/webrtc/modules/remote_bitrate_estimator/include/
...
public interface RemoteBitrateEstimator {
	 ...
	 * 
	 * @param arrivalTimeMs
	 *            can be of an arbitrary time base
	 * @param payloadSize
	 *            the packet size excluding headers
	 * @param ssrc
	 * @param rtpTimestamp
	 */
	void incomingPacket(long arrivalTimeMs, int payloadSize, int ssrc, long rtpTimestamp);
