...
/**
 * Extends the <tt>MediaStream</tt> interface and adds methods specific to audio
 * streaming.
 * 
 * @author Emil Ivov
...
public interface AudioMediaStream extends MediaStream {
	/**
	 * Registers a listener that would receive notification events if the remote
	 * party starts sending DTMF tones to us.
	 * 
	 * @param listener
	 ...
	 * the audio received in/by this <tt>AudioMediaStream</tt> and played back.
	 * 
	 * @param outputVolumeControl
	 *            the <tt>VolumeControl</tt> which is to control the volume
	 *            (level) of the audio received in this
	 ...
	 * @param volume
	 *            The DTMF tone volume. Describes the power level of the tone,
	 *            expressed in dBm0 after dropping the sign.
	 */
	 ...
	 * <tt>startSendingDTMF</tt> method. This method has no effect if no tone is
