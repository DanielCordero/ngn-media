...
public interface MediaService {
	 ...
	 * 
	 * @param listener
	 *            the <tt>PropertyChangeListener</tt> to be notified about
	 ...
	 * 
	 * @param mediaType
	 *            the <tt>MediaType</tt> of the new instance to be initialized
	 ...
	 * 
	 * @param connector
	 *            the <tt>StreamConnector</tt> the stream should use for sending
	 *            and receiving media or <tt>null</tt> if the stream is to not
	 *            have a <tt>StreamConnector</tt> configured at initialization
	 *            time and a <tt>StreamConnector</tt> is to be specified later
	 *            on
	 * @param device
	 *            the device to be used for both capture and playback of media
	 ...
	 *            on
	 * @param mediaType
	 *            the <tt>MediaType</tt> of the media to be exchanged by the new
	 *            instance via the specified <tt>connector</tt>
	 * @return a new <tt>MediaStream</tt> instance which is to exchange media of
	 *         the specified <tt>mediaType</tt> via the specified
	 *         <tt>connector</tt>
	 */
	 ...
	 *            exchanged via the specified <tt>StreamConnector</tt>
	 * @param srtpControl
	 *            a control which is already created, used to control the ZRTP
	 *            operations.
	 * 
	 * @return the newly created <tt>MediaStream</tt>.
	 */
	 ...
	 *            instance via the specified <tt>connector</tt>
	 * @param srtpControl
	 *            the <tt>SrtpControl</tt> to control the security of the media
	 *            exchange
	 * @return a new <tt>MediaStream</tt> instance which is to exchange media of
	 *         the specified <tt>mediaType</tt> via the specified
	 *         <tt>connector</tt>
	 ...
	 * 
	 * @param mediaType
	 *            a <tt>MediaType</tt> value indicating the kind of device that
	 *            we are trying to obtain.
	 * @param useCase
	 *            <tt>MediaUseCase</tt> value indicating for the use-case of
	 ...
	 * 
	 * @param mediaType
	 *            the media type (i.e. AUDIO or VIDEO) that we'd like to obtain
	 *            the device list for.
	 * @param useCase
	 *            <tt>MediaUseCase</tt> value indicating for the use-case of
	 *            device that we are trying to obtain.
	 ...
	 * @return origin
	 */
	public java.awt.Point getOriginForDesktopStreamingDevice(MediaDevice mediaDevice);
	 ...
	 * 
	 * @param listener
	 *            the <tt>PropertyChangeListener</tt> to no longer be notified
	 *            about changes in the values of the properties of this instance
	 */
	 ...
	 *         identifier (CNAME) in RTCP packets sent by this running instance
	 *         of libjitsi.
	 */
