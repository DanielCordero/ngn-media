...
public interface SrtpListener {
	 ...
	 * established the param multiStreamData holds the data needed for the slave
	 * streams to establish their sessions. If this is a securityTurnedOn event
	 * on non master stream the multiStreamData is null.
	 * 
	 * @param mediaType
	 *            the <tt>MediaType</tt> of the call session
	 * @param cipher
	 *            the security cipher that encrypts the call
	 * @param sender
	 *            the control that initiated the event.
	 */
	public void securityTurnedOn(RTPMediaType mediaType, String cipher, SrtpControl sender);
	 ...
	 *            the <tt>MediaType</tt> of the call session
	 */
	public void securityTurnedOff(RTPMediaType mediaType);
	 ...
	 *            the <tt>MediaType</tt> of the call session
	 */
	public void securityTimeout(RTPMediaType mediaType);
	 ...
	 *            the control that initiated the event.
	 */
	public void securityNegotiationStarted(RTPMediaType mediaType, SrtpControl sender);
}
