...
public class RTPExtension {
	 ...
	 * 
	 * @param extensionURI
	 *            the <tt>URI</tt> (possibly a URN) of the RTP extension that
	 *            we'd like to create.
	 */
	 ...
	 *            we'd like to create.
	 * @param direction
	 *            a <tt>MediaDirection</tt> instance indication how this
	 ...
	 *            any attributes that we'd like to add to this extension.
	 */
	 ...
	 * supports for this extension. By default RTP extension headers inherit the
	 * direction of a stream. When explicitly specified <tt>SENDONLY</tt>
	 * direction indicates an ability to attach the extension in outgoing RTP
	 * packets; a <tt>RECVONLY</tt> direction indicates a desire to receive the
	 * extension in incoming packets; a <tt>SENDRECV</tt> direction indicates
	 * both. An <tt>INACTIVE</tt> direction indicates neither, but later
	 * re-negotiation may make an extension active.
	 * 
	 ...
	 *         with this <tt>RTPExtension</tt> or <tt>null</tt> if this
	 *         extension does not have any.
	 */
	 ...
	 * 
	 * @param o
	 *            the <tt>Object</tt> that we'd like to compare to this
	 *            <tt>RTPExtension</tt>.
	 * 
	 ...
	 *         hash code of the <tt>URI</tt> that this extension is
	 *         encapsulating.
	 */
	@Override
	public int hashCode() {
