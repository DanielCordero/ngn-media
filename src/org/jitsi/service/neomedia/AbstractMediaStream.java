...
public abstract class AbstractMediaStream implements MediaStream {
	 ...
	 * 
	 * @param direction
	 *            the <tt>MediaDirection</tt> to validate against the specified
	 *            <tt>deviceDirection</tt>
	 * @param deviceDirection
	 *            the <tt>MediaDirection</tt> of a <tt>MediaDevice</tt> to
	 *            validate against the specified <tt>direction</tt>
	 * @param illegalArgumentExceptionMessage
	 *            the message of the <tt>IllegalArgumentException</tt> to be
	 *            thrown if the state of this instance would've been compromised
	 *            if <tt>direction</tt> and the <tt>MediaDevice</tt> associated
	 *            with <tt>deviceDirection</tt> were both set on this instance
	 * @throws IllegalArgumentException
	 *             if the state of this instance would've been compromised were
	 *             both <tt>direction</tt> and the <tt>MediaDevice</tt>
	 *             associated with <tt>deviceDirection</tt> set on this instance
	 */
	 ...
	 * 
	 * @param property
	 *            the name of the property of this instance which had its value
	 *            changed
	 * @param oldValue
