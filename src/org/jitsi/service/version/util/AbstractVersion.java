...
public abstract class AbstractVersion implements Version {
	 ...
	 * <build-num>.<revision> we will first try to compare them by splitting the
	 * id in components and compare them one by one asnumbers
	 * 
	 * @param v1
	 ...
	 *         or more recent than the one referenced by the <tt>v2</tt>
	 *         parameter.
	 */
