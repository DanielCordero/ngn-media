...
public interface ConfigurationService {
	 ...
	 * Jitsi is to store user specific data such as configuration files, message
	 * and call history.
	 */
	 ...
	 * where Jitsi is to store user specific data such as configuration files,
	 ...
	 *             in case the changed has been refused by at least one
