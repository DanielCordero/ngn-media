...
public class CaptureDeviceInfo2 extends CaptureDeviceInfo {
	 ...
	 * <tt>CaptureDeviceInfo</tt> instance and additional information specific
	 * to the <tt>CaptureDeviceInfo2</tt> class. Because the properties of the
	 * specified <tt>captureDeviceInfo</tt> are copied into the new instance,
	 * the constructor is to be used when a <tt>CaptureDeviceInfo</tt> exists
	 * for other purposes already; otherwise, it is preferable to use
	 * {@link #CaptureDeviceInfo2(String, MediaLocator, Format[], String, String, String)}
	 * .
	 * 
	 * @param captureDeiceInfo
	 *            the <tt>CaptureDeviceInfo</tt> whose properties are to be
	 ...
	 * @param transportType
	 *            the transport type (e.g. USB) of the device to be represented
	 *            by the new instance
	 * @param modelIdentifier
	 *            the persistent identifier of the model of the hardware device
	...
	/**
	 * Initializes a new <tt>CaptureDeviceInfo2</tt> instance with the specified
	 * name, media locator, and array of Format objects.
	 * 
	 * @param name
	 *            the human-readable name of the new instance
	 * @param locator
	 *            the <tt>MediaLocator</tt> which uniquely identifies the device
	 *            to be described by the new instance
	 * @param formats
	 *            an array of the <tt>Format</tt>s supported by the device to be
	 *            described by the new instance
	 * @param uid
	 *            the unique identifier of the hardware device (interface) which
	 *            is to be represented by the new instance
	 * @param transportType
	 ...
	 * 
	 * @param obj
	 *            the <tt>Object</tt> to be determined whether it is equal (by
	 ...
	 * 
	 * @param transportType
	 *            the transport type to compare to the transport type of this
	 *            instance
