...
public abstract class AbstractMediaDevice implements MediaDevice {
	 ...
	 * 
	 * @param dataSource
	 *            the <tt>DataSource</tt> which is to be played back by the new
	 *            <tt>Processor</tt> instance
	 ...
	 *         <tt>null</tt> if the specified <tt>dataSource</tt> is to not be
	 *         played back
	 * @throws Exception
	 *             if an exception is thrown by {@link DataSource#connect()},
