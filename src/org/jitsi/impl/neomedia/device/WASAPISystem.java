...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.CLSID_CWMAudioAEC;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_MEDIA_TYPE_setLSampleSize;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_MEDIA_TYPE_setPbFormat;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_SET_TYPEF_TEST_ONLY;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IID_IMediaObject;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IMediaObject_SetOutputType;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_SYSTEM_MODE;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.SINGLE_CHANNEL_AEC;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.AUDCLNT_SHAREMODE_SHARED;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.AUDCLNT_STREAMFLAGS_EVENTCALLBACK;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.AUDCLNT_STREAMFLAGS_NOPERSIST;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.CLSCTX_ALL;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.CLSID_MMDeviceEnumerator;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.COINIT_MULTITHREADED;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.CoCreateGuid;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.CoCreateInstance;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.CoTaskMemFree;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.DEVICE_STATE_ACTIVE;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IAudioClient_Initialize;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IAudioClient_IsFormatSupported;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IAudioClient_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IAudioClient_SetEventHandle;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IID_IAudioClient;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IID_IMMDeviceEnumerator;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IID_IMMEndpoint;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDeviceCollection_GetCount;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDeviceCollection_Item;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDeviceCollection_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDeviceEnumerator_EnumAudioEndpoints;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDeviceEnumerator_GetDevice;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDeviceEnumerator_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDevice_Activate;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDevice_GetId;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDevice_OpenPropertyStore;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDevice_QueryInterface;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMDevice_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMEndpoint_GetDataFlow;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IMMEndpoint_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IPropertyStore_GetString;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IPropertyStore_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.PKEY_Device_FriendlyName;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.RPC_E_CHANGED_MODE;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.STGM_READ;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.S_FALSE;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVEFORMATEX_getNChannels;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVEFORMATEX_getNSamplesPerSec;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVEFORMATEX_getWBitsPerSample;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVEFORMATEX_getWFormatTag;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.eAll;
...
public class WASAPISystem extends AudioSystem {
	 ...
	 * 
	 * @param format
	 *            the <tt>AudioFormat</tt> on which the alternative
	 *            <tt>AudioFormat</tt>s are to be based
	 * @return an array of alternative <tt>AudioFormat</tt>s based on
	 *         <tt>format</tt> with which an attempt is to be made to initialize
	 *         a new <tt>IAudioClient</tt> instance
	 */
	public static AudioFormat[] getFormatsToInitializeIAudioClient(AudioFormat format) {
		...
		/*
		 * Regardless of the differences in the states of the support of mono
		 * and stereo in the library at the time of this writing, try to
		 * initialize a new IAudioClient instance with a format which will not
		 * require conversion between mono and stereo.
		 */
		format, new AudioFormat(format.getEncoding(), format.getSampleRate(), format.getSampleSizeInBits(), channels, AudioFormat.LITTLE_ENDIAN, AudioFormat.SIGNED, Format.NOT_SPECIFIED /* frameSizeInBits */, Format.NOT_SPECIFIED /* frameRate */, format.getDataType()) };
	}
	 ...
	 * 
	 * @param format
	 *            the <tt>AudioFormat</tt> to get the size in bytes of an audio
	 *            sample of
	 ...
	 * 
	 * @param waveformatex
	 *            the <tt>WAVEFORMATEX</tt> instance to set the fields of from
	 *            the specified <tt>audioFormat</tt>
	 * @param audioFormat
	 *            the <tt>AudioFormat</tt> instance to set the fields of the
	 *            specified <tt>waveformatex</tt> from
	 */
	public static void WAVEFORMATEX_fill(long waveformatex, AudioFormat audioFormat) {
		...
		WASAPI.WAVEFORMATEX_fill(waveformatex, WAVE_FORMAT_PCM, (char) channels, sampleRate, sampleRate * nBlockAlign, nBlockAlign, (char) sampleSizeInBits,
		/* cbSize */(char) 0);
	}
	...
	WASAPISystem() throws Exception {
		super(LOCATOR_PROTOCOL, FEATURE_AGC | FEATURE_DENOISE | FEATURE_ECHO_CANCELLATION | FEATURE_NOTIFY_AND_PLAYBACK_DEVICES | FEATURE_REINITIALIZE);
	}
	 ...
	 *            <tt>IAudioClient</tt>
	 * @param formats
	 *            the <tt>List</tt> of <tt>AudioFormat</tt>s supported by the
	 *            associated <tt>IAudioClient</tt>
	 */
	private void configureSupportedFormats(int dataFlow, List<AudioFormat> formats) {
		...
		case eCapture:
			 ...
			 * CaptureDevice/DataSource implementation will support its formats.
			 */
		...
		case eRender:
			 ...
			 * supported formats with the supported input formats of appropriate
			 * resamplers.
			 */
			for (int i = 0, count = formats.size(); i < count; i++) {
				 ...
				 * stereo.
				 */
				AudioFormat inFormat = new AudioFormat(AudioFormat.LINEAR,
				/* sampleRate */Format.NOT_SPECIFIED,
				/* sampleSizeInBits */Format.NOT_SPECIFIED, outFormat.getChannels(), AbstractAudioRenderer.NATIVE_AUDIO_FORMAT_ENDIAN, AudioFormat.SIGNED,
				/* frameSizeInBits */Format.NOT_SPECIFIED,
				/* frameRate */Format.NOT_SPECIFIED, Format.byteArray);
				@SuppressWarnings("unchecked")
				List<String> classNames = PlugInManager.getPlugInList(inFormat, outFormat, PlugInManager.CODEC);
	...
	protected void doInitialize() throws Exception {
		...
		synchronized (this) {
			...
			/*
			 * XXX Multiple threads may invoke the initialization of a
			 * DeviceSystem so we cannot be sure that the COM library has been
			 * initialized for the current thread.
			 */
			WASAPISystem.CoInitializeEx();

			if (iMMDeviceEnumerator == 0) {
				iMMDeviceEnumerator = CoCreateInstance(CLSID_MMDeviceEnumerator, 0, CLSCTX_ALL, IID_IMMDeviceEnumerator);
				if (iMMDeviceEnumerator == 0)
					throw new IllegalStateException("iMMDeviceEnumerator");

				/*
				 * Register this DeviceSystem to be notified when an audio
				 * endpoint device is added or removed, when the state or
				 * properties of an endpoint device change, or when there is a
			...
			long iMMDeviceCollection = IMMDeviceEnumerator_EnumAudioEndpoints(iMMDeviceEnumerator, eAll, DEVICE_STATE_ACTIVE);
				...
				if (count > 0) {
					...
					try {
						for (int i = 0; i < count; i++) {
							long iMMDevice = IMMDeviceCollection_Item(iMMDeviceCollection, i);
							...
							try {
								 ...
								 * IMMDevice to prevent the initialization of
								 * other IMMDevices.
								 */
	 ...
	 * 
	 * @param iMMDevice
	 *            the <tt>IMMDevice</tt> to initialize as part of the invocation
	 *            of <tt>doInitialize()</tt> on this instance
	 * @throws HResultException
	 *             if an error occurs while initializing the specified
	 *             <tt>iMMDevice</tt> in a native WASAPI function which returns
	 *             an <tt>HRESULT</tt> value
	 * @param captureDevices
	 *            the state of the execution of <tt>doInitialize()</tt> which
	 *            stores the <tt>CaptureDeviceInfo2</tt>s of the capture devices
	 *            discovered by this <tt>WASAPISystem</tt>
	 * @param playbackDevices
	 *            the state of the execution of <tt>doInitialize()</tt> which
	 *            stores the <tt>CaptureDeviceInfo2</tt>s of the playback
	 *            devices discovered by this <tt>WASAPISystem</tt>
	 */
	private void doInitializeIMMDevice(long iMMDevice, List<CaptureDeviceInfo2> captureDevices, List<CaptureDeviceInfo2> playbackDevices) throws HResultException {
		...
		if ((formats != null) && !formats.isEmpty()) {
			...
			if (devices != null) {
				...
				if (!formats.isEmpty()) {
					CaptureDeviceInfo2 cdi2 = new CaptureDeviceInfo2(name, new MediaLocator(LOCATOR_PROTOCOL + ":" + id), formats.toArray(new Format[formats.size()]), id,
					/* transportType */null,
	 ...
	 * <tt>FormatControl</tt> associated with a WASAPI <tt>CaptureDevice</tt>/
	 * <tt>DataSource</tt> or <tt>SourceStream</tt>, it signals that the
	 * <tt>AudioFormat</tt> in question has been included in that
	 * <tt>formats</tt> or <tt>supportedFormat</tt>s only because it is
	 ...
	 *         capture DMO that supports/implements the acoustic echo
	 ...
	 * 
	 * @param iAudioClient
	 *            the <tt>IAudioClient</tt> to get the <tt>List</tt> of
	 ...
	 * @throws HResultException
	 *             if an error occurs while retrieving the <tt>List</tt> of
	 *             <tt>AudioFormat</tt>s supported by the specified
	 *             <tt>iAudioClient</tt> in a native WASAPI function which
	 *             returns an <tt>HRESULT</tt> value
	 */
				...
				for (char wBitsPerSample = 16; wBitsPerSample > 0; wBitsPerSample -= 8) {
					...
					try {
						...
						if (pClosestMatch != waveformatex) {
							...
							if (WAVEFORMATEX_getWFormatTag(pClosestMatch) != WAVE_FORMAT_PCM)
								continue;
						 ...
						 */
						if (nChannels == 2) {
							supportedFormat = new NativelySupportedAudioFormat(AudioFormat.LINEAR, nSamplesPerSec, wBitsPerSample,
							/* channels */1, AbstractAudioRenderer.NATIVE_AUDIO_FORMAT_ENDIAN, AudioFormat.SIGNED,
							/* frameSizeInBits */
						...
						supportedFormat = new NativelySupportedAudioFormat(AudioFormat.LINEAR, nSamplesPerSec, wBitsPerSample, nChannels, AbstractAudioRenderer.NATIVE_AUDIO_FORMAT_ENDIAN, AudioFormat.SIGNED,
						/* frameSizeInBits */Format.NOT_SPECIFIED,
						/* frameRate */Format.NOT_SPECIFIED, Format.byteArray);
						if (!supportedFormats.contains(supportedFormat))
							supportedFormats.add(supportedFormat);
	 ...
	 * 
	 * @param iMediaObject
	 *            the <tt>IMediaObject</tt> to get the <tt>List</tt> of
	 *            supported <tt>AudioFormat</tt>s of
	 * @return a <tt>List</tt> of the <tt>AudioFormat</tt>s supported by the
	 ...
	 *             if an error occurs while retrieving the <tt>List</tt> of
	 *             <tt>AudioFormat</tt>s supported by the specified
	 *             <tt>iMediaObject</tt> in a native WASAPI function which
	 *             returns an <tt>HRESULT</tt> value
	 */
	private List<AudioFormat> getIMediaObjectSupportedFormats(long iMediaObject) throws HResultException {
		...
		try {
			...
			int hresult = DMO_MEDIA_TYPE_fill(pmt,
			...
			for (char nChannels = 1; nChannels <= 2; nChannels++) {
				for (int i = 0; i < Constants.AUDIO_SAMPLE_RATES.length; i++) {
					...
					for (char wBitsPerSample = 16; wBitsPerSample > 0; wBitsPerSample -= 8) {
						...
						try {
							hresult = IMediaObject_SetOutputType(iMediaObject,
							/* dwOutputStreamIndex */0, pmt,
						...
						if (S_OK == hresult) {
							AudioFormat supportedFormat = new AudioFormat(AudioFormat.LINEAR, nSamplesPerSec, wBitsPerSample, nChannels, AbstractAudioRenderer.NATIVE_AUDIO_FORMAT_ENDIAN, AudioFormat.SIGNED,
							/* frameSizeInBits */
							Format.NOT_SPECIFIED,
							/* frameRate */Format.NOT_SPECIFIED, Format.byteArray);
	 ...
	 *         endpoint device that is identified by the specified endpoint ID
	 *         string
	 * @throws HResultException
	 *             if an error occurs while retrieving the audio endpoint device
	 *             that is identified by the specified endpoint ID string in a
	 *             native WASAPI function which returns an <tt>HRESULT</tt>
	 *             value
	 */
	 ...
	 * 
	 * @param iMMDevice
	 *            the <tt>IMMDevice</tt> to get the data flow of
	 * @return an <tt>EDataFlow</tt> value which represents the data flow of the
	 *         specified <tt>IMMDevice</tt>
	 * @throws HResultException
	 *             if an error occurs while retrieving the data flow of the
	 *             specified <tt>iMMDevice</tt> in a native WASAPI function
	 ...
	 * 
	 * @param iMMDevice
	 *            the <tt>IMMDevice</tt> to get the friendly/human-readable name
	 *            of
	 * @return the friendly/human-readable name of the specified
	 *         <tt>iMMDevice</tt>
	 * @throws HResultException
	 *             if an error occurs while retrieving the friendly name of the
	 *             specified <tt>iMMDevice</tt> in a native WASAPI function
	 *             which returns an <tt>HRESULT</tt> value
	 */
	private String getIMMDeviceFriendlyName(long iMMDevice) throws HResultException {
		...
		try {
			deviceFriendlyName = IPropertyStore_GetString(iPropertyStore, PKEY_Device_FriendlyName);
		} finally {
	 ...
	 *            device whose zero-based index within the
	 *            <tt>IMMDeviceCollection</tt> interface is to be retrieved
	 ...
	 *         endpoint ID string if the specified endpoint ID string identifies
	 *         an actual audio endpoint device within the
	 *         <tt>IMMDeviceCollection</tt> interface; otherwise, <tt>-1</tt>
	 * @throws HResultException
	 *             if an error occurs while determining the zero-based index
	 *             within the <tt>IMMDeviceCollection</tt> interface of the
	 *             audio endpoint device identified by the specified endpoint ID
	 *             string in a native WASAPI function which returns an
	 *             <tt>HRESULT</tt> value
	 */
	public synchronized int getIMMDeviceIndex(String id, int dataFlow) throws HResultException {
		...
		long iMMDeviceCollection = IMMDeviceEnumerator_EnumAudioEndpoints(iMMDeviceEnumerator, dataFlow, DEVICE_STATE_ACTIVE);
	 ...
	 *         Capture DSP implementing acoustic echo cancellation (AEC)
	 * @throws Exception
	 *             if initializing the new instance fails
	 */
	public long initializeAEC() throws Exception {
		...
		try {
			iMediaObject = CoCreateInstance(CLSID_CWMAudioAEC,
			/* pUnkOuter */0, CLSCTX_ALL, IID_IMediaObject);
			if (iMediaObject == 0)
				throw new RuntimeException("CoCreateInstance");
			else {
				iPropertyStore = IMediaObject_QueryInterface(iMediaObject, IID_IPropertyStore);
				if (iPropertyStore == 0)
					throw new RuntimeException("IMediaObject_QueryInterface");
				else {
					int hresult = IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_SYSTEM_MODE, SINGLE_CHANNEL_AEC);
	 ...
	 *            device to initialize a new <tt>IAudioClient</tt> instance for
	 * @param dataFlow
	 *            the flow of media data to be supported by the audio endpoint
	 *            device identified by the specified <tt>locator</tt>
	 * @param streamFlags
	 * @param eventHandle
	 * @param hnsBufferDuration
	 *            the base of the duration in milliseconds of the buffer that
	 *            the audio application will share with the audio engine. If
	 *            {@link Format#NOT_SPECIFIED}, the method uses the default
	 *            interval between periodic passes by the audio engine.
	 * @param formats
	 *            an array of alternative <tt>AudioFormat</tt>s with which
	 *            initialization of a new <tt>IAudioClient</tt> instance is to
	 *            be attempted. The first element of the <tt>formats</tt> array
	 *            which is supported by the new <tt>IAudioClient</tt> instance
	 *            is used to initialize it and any preceding elements are set to
	 *            <tt>null</tt> to signify that they are not supported and to
	 *            make it possible to retrieve the <tt>AudioFormat</tt> with
	 *            which the new <tt>IAudioClient</tt> instance has been
	 *            initialized.
	 ...
	 *             <tt>IAudioClient</tt> for the audio endpoint device
	 *             identified by the specified <tt>locator</tt> in a native
	 *             WASAPI function which returns an <tt>HRESULT</tt> value
	 */
	public long initializeIAudioClient(MediaLocator locator, DataFlow dataFlow, int streamFlags, long eventHandle, long hnsBufferDuration, AudioFormat[] formats) throws HResultException {
		...
		try {
			...
			switch (dataFlow) {
			case CAPTURE:
				if ((iMMDeviceDataFlow != eAll) && (iMMDeviceDataFlow != eCapture))
					throw new IllegalArgumentException("dataFlow");
				break;
			case NOTIFY:
			case PLAYBACK:
				if ((iMMDeviceDataFlow != eAll) && (iMMDeviceDataFlow != eRender))
					throw new IllegalArgumentException("dataFlow");
				break;
			}
			...
			try {
				...
				try {
					...
					int hresult = IAudioClient_Initialize(iAudioClient, shareMode, streamFlags, 3 * hnsBufferDuration * 10000,
					/* hnsPeriodicity */0, waveformatex, audioSessionGuid);
	 ...
	 * <tt>DataFlow</tt> and a specific <tt>MediaLocator</tt> does not support a
	 * specific list of <tt>Format</tt>s.
	 * 
	 * @param dataFlow
	 *            the flow of the media supported by the device which does not
	 *            support the specified <tt>Format</tt>s
	 * @param locator
	 *            the <tt>MediaLocator</tt> identifying the device which does
	 *            not support the specified <tt>Format</tt>s
	 * @param unsupportedFormats
	 *            the list of <tt>Format</tt> which are not supported by the
	 *            device identified by the specified <tt>dataFlow</tt> and
	 *            <tt>locator</tt>
	 */
		...
		try {
			...
			try {
				...
				if (!supportedFormats.isEmpty()) {
					aecIMediaObject = iMediaObject;
					iMediaObject = 0;
					aecSupportedFormats = Collections.unmodifiableList(supportedFormats);
				}
			} finally {
				if (iMediaObject != 0)
					IMediaObject_Release(iMediaObject);
	...
	protected void preInitialize() throws Exception {
		...
		if (pNotify == null) {
			pNotify = new IMMNotificationClient() {
	 ...
	 * 
	 * @param deviceId
	 *            the endpoint ID string that identifies the audio endpoint
