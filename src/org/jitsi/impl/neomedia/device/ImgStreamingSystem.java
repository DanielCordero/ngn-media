...
public class ImgStreamingSystem extends DeviceSystem {
	/**
	 * The locator protocol used when creating or parsing <tt>MediaLocator</tt>
	 * s.
	 */
	...
	public ImgStreamingSystem() throws Exception {
		super(RTPMediaType.VIDEO, LOCATOR_PROTOCOL, FEATURE_REINITIALIZE);
	}
	...
	protected void doInitialize() throws Exception {
		...
		for (ScreenDevice screen : screens) {
			...
			CaptureDeviceInfo cdi = new CaptureDeviceInfo(name + " " + i, new MediaLocator(LOCATOR_PROTOCOL + ":" + i), formats);
