...
public class ReceiveStreamPushBufferDataSource extends PushBufferDataSourceDelegate<PushBufferDataSource> {
	 ...
	 * 
	 * @param receiveStream
	 *            the <tt>ReceiveStream</tt> on which to set a
	 *            <tt>BufferTransferHandler</tt> which reads data as soon as
	 *            possible and throws it away
	 */
	 ...
	 * 
	 * @param receiveStream
	 *            the <tt>ReceiveStream</tt> which is to have its
	 *            <tt>DataSource</tt>
	 * @param dataSource
	 *            the <tt>DataSource</tt> of <tt>receiveStream</tt> which is to
	 *            be wrapped by this instance
	 */
	 ...
	 *            <tt>true</tt> if calls to <tt>DataSource#disconnect()</tt> on
	 *            the wrapped <tt>dataSource</tt> are to be suppressed when
	 *            there are such calls on the new instance; otherwise,
	 *            <tt>false</tt>
	 */
	 ...
	 * 
	 * @param suppressDisconnect
	 *            <tt>true</tt> to suppress calls to
	 *            <tt>DataSource#disconnect()</tt> on the wrapped
	 *            <tt>DataSource</tt> when there are such calls on this
