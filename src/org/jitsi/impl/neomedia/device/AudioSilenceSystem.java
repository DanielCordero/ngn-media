...
public class AudioSilenceSystem extends AudioSystem {
	...
	protected void doInitialize() throws Exception {
		CaptureDeviceInfo2 captureDevice = new CaptureDeviceInfo2("AudioSilenceCaptureDevice", new MediaLocator(LOCATOR_PROTOCOL + ":"), DataSource.SUPPORTED_FORMATS, null, null, null);
