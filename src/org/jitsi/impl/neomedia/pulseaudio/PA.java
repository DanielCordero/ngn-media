...
public final class PA {
	...
	public static native long buffer_attr_new(int maxlength, int tlength, int prebuf, int minreq, int fragsize);

	public static native int context_connect(long c, String server, int flags, long api);

	public static native void context_disconnect(long c);

	public static native long context_get_sink_info_list(long c, sink_info_cb_t cb);

	public static native long context_get_source_info_list(long c, source_info_cb_t cb);

	public static native int context_get_state(long c);

	public static native long context_new_with_proplist(long mainloop, String name, long proplist);

	public static native long context_set_sink_input_volume(long c, int idx, long volume, context_success_cb_t cb);

	public static native long context_set_source_output_volume(long c, int idx, long volume, context_success_cb_t cb);
	...
	public static native long sample_spec_new(int format, int rate, int channels);
	...
	public static native int stream_connect_playback(long s, String dev, long attr, int flags, long volume, long syncStream);

	public static native int stream_connect_record(long s, String dev, long attr, int flags);

	public static native long stream_cork(long s, boolean b, stream_success_cb_t cb);
	 ...
	 * 
	 * @param s
	 *            the <tt>pa_stream</tt> of which to get the name of the sink or
	...
	public static native long stream_new_with_proplist(long c, String name, long ss, long map, long p);

	public static native int stream_peek(long s, byte[] data, int dataOffset);

	public static native int stream_readable_size(long s);

	public static native void stream_set_read_callback(long s, stream_request_cb_t cb);

	public static native void stream_set_state_callback(long s, Runnable cb);

	public static native void stream_set_write_callback(long s, stream_request_cb_t cb);

	public static native void stream_unref(long s);

	public static native int stream_writable_size(long s);

	public static native int stream_write(long s, byte[] data, int dataOffset, int dataLength, Runnable freeCb, long offset, int seek);
	...
	public static native void threaded_mainloop_signal(long m, boolean waitForAccept);
