...
public class ArrayIOUtils {
	 ...
	 * @param inOffset
	 *            the offset in <tt>in</tt> at which the reading of the integer
	 *            is to start
	...
	public static int readInt(byte[] in, int inOffset) {
		return (in[inOffset + 3] << 24) | ((in[inOffset + 2] & 0xFF) << 16) | ((in[inOffset + 1] & 0xFF) << 8) | (in[inOffset] & 0xFF);
	}
	 ...
	 * @param inOffset
	 *            the offset in <tt>in</tt> at which the reading of the short
	 *            integer is to start
	 ...
	 * 
	 * @param in
	 *            the integer to be written out as a series of bytes
	 * @param out
	 *            the output to receive the conversion of the specified integer
	 *            to a series of bytes
	 * @param outOffset
	 *            the offset in <tt>out</tt> at which the writing of the result
	 *            of the conversion is to be started
	 */
