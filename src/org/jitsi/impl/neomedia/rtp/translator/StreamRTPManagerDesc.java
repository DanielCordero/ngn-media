...
/**
 * Describes additional information about a <tt>StreamRTPManager</tt> for the
 * purposes of <tt>RTPTranslatorImpl</tt>.
 * 
...
class StreamRTPManagerDesc {
	 ...
	 *            the <tt>StreamRTPManager</tt> to be described by the new
	 *            instance
	 */
	...
	/**
	 * Adds a new synchronization source (SSRC) identifier to the list of SSRC
	 * received by the associated <tt>StreamRTPManager</tt>.
	 * 
	 * @param receiveSSRC
	 *            the new SSRC to add to the list of SSRC received by the
	...
	/**
	 * Determines whether the list of synchronization source (SSRC) identifiers
	 * received by the associated <tt>StreamRTPManager</tt> contains a specific
	 * SSRC.
	 * 
	 * @param receiveSSRC
	 *            the SSRC to check whether it is contained in the list of SSRC
	 *            received by the associated <tt>StreamRTPManager</tt>
	 * @return <tt>true</tt> if the specified <tt>receiveSSRC</tt> is contained
	 *         in the list of SSRC received by the associated
	...
	public ReceiveStreamListener[] getReceiveStreamListeners() {
		synchronized (receiveStreamListeners) {
			return receiveStreamListeners.toArray(new ReceiveStreamListener[receiveStreamListeners.size()]);
		}
	}
