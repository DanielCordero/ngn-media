...
class SendStreamDesc {
	...
	/**
	 * The <tt>SendStream</tt> created from the stream of {@link #dataSource} at
	 * index {@link #streamIndex}.
	 */
	...
	/**
	 * The number of <tt>StreamRTPManager</tt>s which have started their views
	 * of {@link #sendStream}.
	 */
	private int started;
