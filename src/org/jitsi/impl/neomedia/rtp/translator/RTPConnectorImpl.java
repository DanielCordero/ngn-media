...
/**
 * Implements the <tt>RTPConnector</tt> with which this instance initializes its
 * <tt>RTPManager</tt>. It delegates to the <tt>RTPConnector</tt> of the various
 * <tt>StreamRTPManager</tt>s.
 * 
