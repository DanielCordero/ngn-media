 ...
 */
public class BasicRTCPTerminationStrategy implements RTCPTerminationStrategy, RTCPPacketTransformer, RTCPReportBuilder {
	/**
     *
     */
	...
	private void onRTCPTransmitterChanged() {
		RTCPTransmitter t;
		SSRCCache c;
		if ((t = this.rtcpTransmitter) != null && (c = t.cache) != null) {
	...
	/**
	 * 1. Removes receiver report blocks from RRs and SRs and kills REMBs. 2.
	 * Updates the receiver feedback cache.
	 * 
	 * @param inPacket
	 * @return
	 */
