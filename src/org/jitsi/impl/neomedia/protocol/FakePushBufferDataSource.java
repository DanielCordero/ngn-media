...
public class FakePushBufferDataSource extends AbstractPushBufferCaptureDevice {
	 ...
	 *            the list of <tt>Format</tt>s to be reported as supported by
	 *            the new instance
	 */
	...
	private static class FakePushBufferStream extends AbstractPushBufferStream<FakePushBufferDataSource> {
		 ...
		 * 
		 * @param dataSource
		 *            the <tt>FakePushBufferDataSource</tt> which is creating
		 *            the new instance so that it becomes one of its
		 *            <tt>streams</tt>
		 * @param formatControl
		 *            the <tt>FormatControl</tt> which is to abstract the
		 *            <tt>Format</tt>-related information of the new instance
		 ...
		 *             <tt>PushBufferStream</tt> into the specified
		 *             <tt>buffer</tt>
		 */
		@Override
