...
public class CaptureDeviceDelegatePullBufferDataSource extends PullBufferDataSource implements CaptureDevice {
	 ...
	 * 
	 * @param captureDevice
	 *            the <tt>CaptureDevice</tt> the new instance is to delegate to
	 *            in order to provide its <tt>CaptureDevice</tt> functionality
	 */
	 ...
	 *         <tt>CaptureDevice</tt> if it implements
	 *         <tt>PullBufferDataSource</tt>; otherwise, an empty array with
	 *         <tt>PullBufferStream</tt> element type
	 */
	@Override
	 ...
	 * 
	 * @throws IOException
	 *             if the wrapped <tt>CaptureDevice</tt> throws such an
	 *             exception
	 */
	@Override
	 ...
	 * 
	 * @param controlType
	 *            a <tt>String</tt> value which names the type of the control to
	 *            be retrieved
	 ...
	 *         its implementation of <tt>DataSource</tt> if any; otherwise,
	 *         returns <tt>DataSource#DURATION_UNKNOWN</tt>
	 */
	@Override
	 ...
	 *         <tt>CaptureDevice</tt> if available; otherwise, an empty array
	 *         with <tt>FormatControl</tt> element type
	 */
	...
	public CaptureDeviceInfo getCaptureDeviceInfo() {
		return (captureDevice != null) ? captureDevice.getCaptureDeviceInfo() : null;
	}
}
