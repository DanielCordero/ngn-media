...
public class TranscodingDataSource extends DataSource {
	 ...
	 *            the <tt>DataSource</tt> which is to have its tracks transcoded
	 *            in a specific output <tt>Format</tt>
	 * @param outputFormat
	 *            the <tt>Format</tt> in which the new instance is to transcode
	 ...
	 * 
	 * @throws IOException
	 *             if creating the transcoding <tt>Processor</tt>, setting its
	 *             <tt>Format</tt> or connecting to it fails
	 */
	@Override
	...
	public synchronized Object[] getControls() {
		return (outputDataSource == null) ? ControlsAdapter.EMPTY_CONTROLS : outputDataSource.getControls();
	}
