...
/**
 * This class represent a rtpdump file and provide an API to get the payload of
 * the rtp packet it contains.
 * 
 * rtpdump format : - http://www.cs.columbia.edu/irt/software/rtptools/ -
 * https:/
 * /gist.github.com/Haerezis/18e3ffc2d69c86f8463f#file-rtpdump_file_format
 * (backup gist)
 * 
 * 
 * rtpdump file can be generated with wireshark from RTP stream, just go to : ->
 * Telephony -> RTP -> Show All Streams then select the RTP stream you want to
 * record, and click on "Save As".
 * 
...
public class RtpdumpFileReader {
	 ...
	 * rtp_write_header that write the file header, show that this header is
	 * 4+4+4+2+2=16 bytes.
	 */
	 ...
	 * 
	 * @param filePath
	 *            the location of the rtpdump file this
	 ...
	 * 
	 * @param loopFile
	 *            if true, when the end of the rtpdump file is reached, this
	 *            <tt>RtpdumpFileReader</tt> will go back at the beginning of
	 *            the file and get the first packet.
	 * @return a <tt>RawPacket</tt> containing all the information and data of
	 *         the next rtp packet recorded in the rtpdump file
	 * @throws IOException
	 *             if <tt>loopFile</tt> was false and the end of the file is
	 *             reached.
	 */
	...
	/**
	 * Go to the beginning of the rtpdump file and skip the first line of ascii
	 * (giving the file version) and skip the file header (useless)
	 * 
	 * @throws IOException
	 *             if an error occur during the seek and reading of the file.
	 */
