...
public class VideoGreyFadingMediaDevice extends MediaDeviceImpl {
	 ...
	 * 
	 * @param dimension
	 *            the dimension (width & height) of the <tt>CaptureDevice</tt>
	 *            behind this <tt>MediaDevice</tt>.
	 */
	...
	public VideoGreyFadingMediaDevice(int framerate, Dimension dimension) {
		super(new CaptureDeviceInfo("GreyFadingVideo", new MediaLocator("greyfading:"), new Format[] { new RGBFormat(dimension, // size
				Format.NOT_SPECIFIED, // maxDataLength
				Format.byteArray, // dataType
				framerate, // frameRate
				32, // bitsPerPixel
				2 /* red */, 3 /* green */, 4 /* blue */) }), RTPMediaType.VIDEO);
	}
}
