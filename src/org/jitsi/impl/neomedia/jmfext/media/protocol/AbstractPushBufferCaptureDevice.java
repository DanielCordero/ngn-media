...
public abstract class AbstractPushBufferCaptureDevice extends PushBufferDataSource implements CaptureDevice {
	 ...
	 */
	private final AbstractBufferCaptureDevice<AbstractPushBufferStream<?>> impl = new AbstractBufferCaptureDevice<AbstractPushBufferStream<?>>() {
		@Override
		...
		/**
		 * Overrides {@link AbstractBufferCaptureDevice#getControls()} to add
		 * controls specific to this <tt>AbstractPushBufferCaptureDevice</tt>.
		 * 
		 * {@inheritDoc}
		 */
		@Override
	 ...
	 *             media source specified by the <tt>MediaLocator</tt> of this
	 *             <tt>DataSource</tt>
	 */
	@Override
	 ...
	 * the new instance is to be abstracted by a specific <tt>FormatControl</tt>
	 * .
	 * 
	 * @param streamIndex
	 ...
	 *         <tt>PushBufferDataSource</tt> and which has its <tt>Format</tt>
	 *         -related information abstracted by the specified
	 *         <tt>formatControl</tt>
	 */
	 ...
	 *             data from this <tt>DataSource</tt>
	 */
	protected void doStart() throws IOException {
		impl.defaultDoStart();
	}
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>PushBufferStream</tt> for
	 ...
	 *         which this <tt>AbstractPushBufferCaptureDevice</tt> gives access
	 *         to its media data
	 */
