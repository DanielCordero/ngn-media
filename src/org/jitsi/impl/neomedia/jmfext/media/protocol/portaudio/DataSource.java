...
public class DataSource extends AbstractPullBufferCaptureDevice {
	...
	/**
	 * The indicator which determines whether this <tt>DataSource</tt> will use
	 * audio quality improvement in accord with the preferences of the user.
	 */
	private final boolean audioQualityImprovement;

	/**
	 * The list of <tt>Format</tt>s in which this <tt>DataSource</tt> is capable
	 * of capturing audio data.
	 */
	...
	/**
	 * Initializes a new <tt>DataSource</tt> instance from a specific
	 * <tt>MediaLocator</tt> and which has a specific list of <tt>Format</tt> in
	 * which it is capable of capturing audio data overriding its registration
	 * with JMF and optionally uses audio quality improvement in accord with the
	 * preferences of the user.
	 * 
	 * @param locator
	 *            the <tt>MediaLocator</tt> to create the new instance from
	 * @param supportedFormats
	 *            the list of <tt>Format</tt>s in which the new instance is to
	 *            be capable of capturing audio data
	 * @param audioQualityImprovement
	 *            <tt>true</tt> if audio quality improvement is to be enabled in
	 *            accord with the preferences of the user or <tt>false</tt> to
	 ...
	 *             if there is no <tt>MediaLocator</tt> associated with this
	 *             <tt>DataSource</tt>
	 */
	 ...
	 * 
	 * @param locator
	 *            the <tt>MediaLocator</tt> identifying the device index of a
	 *            PortAudio device to get
	...
	protected Format[] getSupportedFormats(int streamIndex) {
		return (supportedFormats == null) ? super.getSupportedFormats(streamIndex) : supportedFormats;
	}
}
