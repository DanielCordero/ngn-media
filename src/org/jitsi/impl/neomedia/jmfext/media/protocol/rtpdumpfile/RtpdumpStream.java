...
public class RtpdumpStream extends AbstractVideoPullBufferStream<DataSource> {
	...
	/**
	 * The timestamp of the last rtp packet (the timestamp change only when a
	 * marked packet has been sent).
	 */
	...
	/**
	 * The <tt>RtpdumpFileReader</tt> used by this stream to get the rtp
	 * payload.
	 */
	 ...
	 * @param formatControl
	 *            the <tt>FormatControl</tt> of the new instance which is to
	 *            specify the format in which it is to provide its media data
	 */
