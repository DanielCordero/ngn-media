...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_E_NOTACCEPTING;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_INPUT_STATUSF_ACCEPT_DATA;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_MEDIA_TYPE_fill;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_MEDIA_TYPE_setCbFormat;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_MEDIA_TYPE_setFormattype;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_MEDIA_TYPE_setPbFormat;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_OUTPUT_DATA_BUFFERF_INCOMPLETE;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_OUTPUT_DATA_BUFFER_alloc;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.DMO_OUTPUT_DATA_BUFFER_getDwStatus;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.FORMAT_None;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.FORMAT_WaveFormatEx;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IID_IPropertyStore;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IMediaObject_Flush;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IMediaObject_GetInputStatus;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IMediaObject_ProcessInput;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IMediaObject_ProcessOutput;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IMediaObject_QueryInterface;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IMediaObject_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.IPropertyStore_SetValue;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MEDIASUBTYPE_PCM;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MEDIATYPE_Audio;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_DEVICE_INDEXES;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_DMO_SOURCE_MODE;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_FEATR_AES;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_FEATR_AGC;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_FEATR_ECHO_LENGTH;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_FEATR_NS;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_FEATURE_MODE;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MFPKEY_WMAAECMA_MIC_GAIN_BOUNDER;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MediaBuffer_alloc;
...
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MoCreateMediaType;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.VoiceCaptureDSP.MoDeleteMediaType;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.CoTaskMemFree;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.FAILED;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.IPropertyStore_Release;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.SUCCEEDED;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.S_OK;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVEFORMATEX_alloc;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVEFORMATEX_fill;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVEFORMATEX_sizeof;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.WAVE_FORMAT_PCM;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.eCapture;
import static org.jitsi.impl.neomedia.jmfext.media.protocol.wasapi.WASAPI.eRender;
...
public class WASAPIStream extends AbstractPushBufferStream<DataSource> {
	 ...
	 * 
	 * @param formats
	 *            the list of <tt>Format</tt>s into which an
	 *            <tt>AudioFormat</tt> as similar to the specified
	 *            <tt>format</tt> as possible is to be found
	 * @param format
	 *            the <tt>AudioFormat</tt> for which a similar
	 *            <tt>AudioFormat</tt> is to be found in <tt>formats</tt>
	 * @param clazz
	 *            the runtime type of the matches to be considered or
	...
	private static AudioFormat findClosestMatch(Format[] formats, AudioFormat format, Class<? extends AudioFormat> clazz) {
		...
		if (match == null) {
			 ...
			 */
			match = findFirstMatch(formats, new AudioFormat(format.getEncoding(), format.getSampleRate(), format.getSampleSizeInBits(),
			/* channels */Format.NOT_SPECIFIED, format.getEndian(), format.getSigned(),
			/* frameSizeInBits */Format.NOT_SPECIFIED,
			/* frameRate */Format.NOT_SPECIFIED, format.getDataType()), clazz);
			if (match == null) {
				/*
				 ...
				 */
				match = findFirstMatch(formats, new AudioFormat(format.getEncoding(),
				/* sampleRate */Format.NOT_SPECIFIED, format.getSampleSizeInBits(),
				/* channels */Format.NOT_SPECIFIED, format.getEndian(), format.getSigned(),
				/* frameSizeInBits */Format.NOT_SPECIFIED,
				/* frameRate */Format.NOT_SPECIFIED, format.getDataType()), clazz);
			}
	 ...
	 * 
	 * @param formats
	 *            the list of <tt>AudioFormat</tt>s into which an
	 *            <tt>AudioFormat</tt> as similar to the specified
	 *            <tt>format</tt> as possible is to be found
	 * @param format
	 *            the <tt>AudioFormat</tt> for which a similar
	...
	private static AudioFormat findClosestMatch(List<AudioFormat> formats, AudioFormat format, Class<? extends AudioFormat> clazz) {
		return findClosestMatch(formats.toArray(new Format[formats.size()]), format, clazz);
	}
	 ...
	 * 
	 * @param formats
	 *            the array of <tt>Format</tt>s which si to be searched
	 * @param format
	 *            the <tt>AudioFormat</tt> for which a match is to be found in
	 *            the specified <tt>formats</tt>
	 * @param clazz
	 *            the runtime type of the matches to be considered or
	 *            <tt>null</tt> if the runtime type is to not be limited
	 ...
	 * @param inOrOut
	 *            <tt>true</tt> if the media type of an input stream of the
	 *            specified <tt>iMediaObject</tt> is to be set or <tt>false</tt>
	 *            if the media type of an output stream of the specified
	 *            <tt>iMediaObject</tT> is to be set
	 * @param dwXXXputStreamIndex
	 *            the zero-based index of the input or output stream on the
	 *            specified <tt>iMediaObject</tt> of which the media type is to
	 *            be set
	 * @param audioFormat
	 *            the <tt>AudioFormat</tt> to be set on the specified stream of
	 *            the DMO
	 * @param dwFlags
	 *            bitwise combination of zero or more <tt>DMO_SET_TYPEF_XXX</tt>
	 *            flags (defined by the <tt>VoiceCaptureDSP</tt> class
	 ...
	 *             if setting the media type of the specified stream of the
	 *             specified <tt>iMediaObject</tt> fails
	 */
	private static int IMediaObject_SetXXXputType(long iMediaObject, boolean inOrOut, int dwXXXputStreamIndex, AudioFormat audioFormat, int dwFlags) throws HResultException {
		...
		try {
			WAVEFORMATEX_fill(waveformatex, WAVE_FORMAT_PCM, nChannels, nSamplesPerSec, nSamplesPerSec * nBlockAlign, nBlockAlign, wBitsPerSample, cbSize);
			...
			try {
				...
				hresult = DMO_MEDIA_TYPE_fill(pmt,
				/* majortype */MEDIATYPE_Audio,
				/* subtype */MEDIASUBTYPE_PCM,
				/* bFixedSizeSamples */true,
				/* bTemporalCompression */false, wBitsPerSample / 8,
				/* formattype */FORMAT_WaveFormatEx,
				/* pUnk */0, cbFormat, waveformatex);
				if (FAILED(hresult))
					throw new HResultException(hresult, "DMO_MEDIA_TYPE_fill");
				hresult = inOrOut ? VoiceCaptureDSP.IMediaObject_SetInputType(iMediaObject, dwXXXputStreamIndex, pmt, dwFlags) : VoiceCaptureDSP.IMediaObject_SetOutputType(iMediaObject, dwXXXputStreamIndex, pmt, dwFlags);
				if (FAILED(hresult)) {
	 ...
	 * 
	 * @param iMediaBuffer
	 *            the <tt>IMediaBuffer</tt> on which the method
	 ...
	 * 
	 * @param pBuffer
	 *            the <tt>IMediaBuffer</tt> into which the specified bytes are
	 *            to be pushed/written
	 * @param buffer
	 *            the bytes to be pushed/written into the specified
	 *            <tt>pBuffer</tt>
	 * @param offset
	 *            the offset in <tt>buffer</tt> at which the bytes to be
	 *            pushed/written into the specified <tt>pBuffer</tt> start
	 * @param length
	 *            the number of bytes in <tt>buffer</tt> starting at
	 *            <tt>offset</tt> to be pushed/written into the specified
	 *            <tt>pBuffer</tt>
	...
	private static int maybeMediaBufferPush(long pBuffer, byte[] buffer, int offset, int length) {
		...
		if ((exception != null) || (written != length)) {
			logger.error("Failed to push/write " + ((written <= 0) ? length : (length - written)) + " bytes into an IMediaBuffer.", exception);
		}
		return written;
	}
	 ...
	 * 
	 * @param message
	 *            the message to initialize the new <tt>IOException</tt>
	 *            instance with
	 * @param hre
	 *            an <tt>HResultException</tt> which is to be set as the
	...
	/**
	 * The <tt>AudioFormat</tt> of the {@link #capture} or {@link #iMediaObject}
	 * . If it does not match (in the FMJ sense of the <tt>Format</tt> class),
	 * {@link #resampler} will be used to resample from it into {@link #format}.
	 */
	 ...
	 * 
	 * @param dataSource
	 *            the <tt>DataSource</tt> which is initializing the new instance
	 *            so that it becomes one of its <tt>streams</tt>
	 * @param formatControl
	 ...
	 * 
	 * @param length
	 *            the number of bytes comprising the audio samples of which the
	 *            duration in nanoseconds is to be computed/determined
	 * @return the duration in nanoseconds of audio samples which are
	 *         represented by the specified number of bytes and which are
	 *         encoded in the <tt>outFormat</tt> of <tt>capture</tt>
	 */
	 ...
	 * 
	 * @param duration
	 *            the duration in nanoseconds of the audio samples of which the
	 *            number of bytes is to be computed/determined
	 * @return the number of bytes of the specified duration in nanoseconds of
	 *         audio samples encoded in the <tt>outFormat</tt> of
	 *         <tt>render</tt>
	 */
	 ...
	 * 
	 * @param iPropertyStore
	 *            a reference to the <tt>IPropertyStore</tt> interface of the
	 *            Voice Capture DSP that implements acoustic echo cancellation
	 *            (AEC)
	 */
	private void configureAEC(long iPropertyStore) throws HResultException {
		...
		try {
			if (MFPKEY_WMAAECMA_FEATURE_MODE != 0) {
				IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_FEATURE_MODE, true);
				...
				if (MFPKEY_WMAAECMA_FEATR_AES != 0) {
					IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_FEATR_AES, audioSystem.isEchoCancel() ? 2 : 0);
				}
				...
				if (MFPKEY_WMAAECMA_FEATR_AGC != 0) {
					IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_FEATR_AGC, isAGC);
				}
				/*
				...
				if (MFPKEY_WMAAECMA_MIC_GAIN_BOUNDER != 0) {
					IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_MIC_GAIN_BOUNDER, isAGC);
				}

				// Perform noise suppression (NS).
				if (MFPKEY_WMAAECMA_FEATR_NS != 0) {
					IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_FEATR_NS, audioSystem.isDenoise() ? 1 : 0);
				}
				if (MFPKEY_WMAAECMA_FEATR_ECHO_LENGTH != 0) {
					IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_FEATR_ECHO_LENGTH, 256);
				}
			}
		} catch (HResultException hre) {
	 ...
	 * 
	 * @throws IOException
	 *             if this <tt>SourceStream</tt> is disconnected and fails to
	 *             connect to the audio endpoint device identified by
	 *             <tt>locator</tt>
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if anything goes wrong while this <tt>SourceStream</tt>
	 *             disconnects from the audio endpoint device it has previously
	 *             connected to during the execution of <tt>connect()</tt>
	 */
	private synchronized void disconnect() throws IOException {
		try {
			...
			dataSource.audioSystem.removePropertyChangeListener(propertyChangeListener);
		}
	}
	 ...
	 * 
	 * @throws Exception
	 *             if this <tt>SourceStream</tt> fails to connect to the
	 *             associated audio endpoint device. The <tt>Exception</tt> is
	 *             logged by the <tt>connect()</tt> method.
	 */
		...
		if (dataSource.aec) {
			...
			try {
				...
				if (captureDevice != null) {
					 ...
					 */
					CaptureDeviceInfo2 renderDevice = audioSystem.getSelectedDevice(AudioSystem.DataFlow.PLAYBACK);
	 ...
	 * 
	 * @param captureDevice
	 *            a <tt>CaptureDeviceInfo2</tt> which identifies the capture
	 *            endpoint device to be used
	 * @param renderDevice
	 *            a <tt>CaptureDeviceInfo2</tt> which identifies the render
	 *            endpoint device to be used
	 * @param outFormat
	 *            the <tt>Format</tt> of the media data in which the Voice
	...
	private AudioFormat doConnectInFilterMode(CaptureDeviceInfo2 captureDevice, CaptureDeviceInfo2 renderDevice, AudioFormat outFormat) throws Exception {
		...
		if (captureFormat == null) {
			throw new IllegalStateException("Failed to determine an AudioFormat with which to" + " initialize IAudioClient for MediaLocator " + locator + " based on AudioFormat " + outFormat);
		}
		...
		try {
			...
			try {
				aecOutFormat = initializeAEC(
				/* sourceMode */false, captureDevice, captureFormat, renderDevice, renderFormat, outFormat);
				uninitialize = false;
			} finally {
				if (uninitialize)
					uninitializeRender();
	...
	private AudioFormat doConnectInSourceMode(CaptureDeviceInfo2 captureDevice, CaptureDeviceInfo2 renderDevice, AudioFormat outFormat) throws Exception {
		...
		/* sourceMode */true, captureDevice,
		/* captureFormat */null, renderDevice,
		/* renderFormat */null, outFormat);
	}
	 ...
	 * @throws IOException
	 *             if an error occurs during the reading or writing
	 */
	private void doRead(Buffer buffer) throws IOException {
		...
		do {
			...
			synchronized (this) {
				 ...
				 * We explicitly want to support the case in which the user has
				 * selected "none" for the playback/render endpoint device.
				 * Otherwise, we could have added a check (dataSource.aec &&
				 * (render == null)).
				 */
	 ...
	 * @param format
	 *            the <tt>AudioFormat</tt> for which a similar
	 *            <tt>AudioFormat</tt> is to be found in the list of supported
	 *            formats of the associated capture endpoint device
	 * @return an <tt>AudioFormat</tt> which is an element of the list of
	 *         supported formats of the associated capture endpoint device and
	 *         is as similar to the specified <tt>format</tt> as possible or
	 *         <tt>null</tt> if no similarity could be established
	 */
	 ...
	 *         audio endpoint device this <tt>SourceStream</tt> is to capture
	 *         data from
	 */
	 ...
	 * 
	 * @param sourceMode
	 *            <tt>true</tt> if the Voice Capture DSP is to be initialized in
	 *            source mode or <tt>false</tt> if the Voice Capture DSP is to
	 *            be initialized in filter mode
	 * @param captureDevice
	 *            a <tt>CaptureDeviceInfo2</tt> which identifies the capture
	 *            endpoint device to be used
	 * @param captureFormat
	 *            the <tt>AudioFormat</tt> of the media which will be delivered
	 *            to the input stream representing the audio from the microphone
	 * @param renderDevice
	 *            <tt>CaptureDeviceInfo2</tt> which identifies the render
	 *            endpoint device to be used
	 * @param renderFormat
	 *            the <tt>AudioFormat</tt> of the media which will be delivered
	 *            to the input stream representing the audio from the speaker
	 *            (line)
	 * @param outFormat
	 *            the <tt>AudioFormat</tt> of the media which is to be output by
	 *            the <tt>IMediaObject</tt>/acoustic echo cancellation (AEC)
	 * @return the <tt>AudioFormat</tt> in which the Voice Capture DSP will
	 *         actually output media data
	 * @throws Exception
	 *             if the initialization of the <tt>IMediaObject</tt>
	...
	private AudioFormat initializeAEC(boolean sourceMode, CaptureDeviceInfo2 captureDevice, AudioFormat captureFormat, CaptureDeviceInfo2 renderDevice, AudioFormat renderFormat, AudioFormat outFormat) throws Exception {
		WASAPISystem audioSystem = dataSource.audioSystem;
		AudioFormat aecOutFormat = findClosestMatch(audioSystem.getAECSupportedFormats(), outFormat,
		/* clazz */null);
		...
		try {
			long iPropertyStore = IMediaObject_QueryInterface(iMediaObject, IID_IPropertyStore);

			if (iPropertyStore == 0) {
				throw new RuntimeException("IMediaObject_QueryInterface IID_IPropertyStore");
			}
			try {
				int hresult = IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_DMO_SOURCE_MODE, sourceMode);
				...
				hresult = IMediaObject_SetXXXputType(iMediaObject,
				/* IMediaObject_SetOutputType */false,
				/* dwOutputStreamIndex */0, aecOutFormat,
				/* dwFlags */0);
				if (FAILED(hresult)) {
				...
				int outFrames = (int) (WASAPISystem.DEFAULT_BUFFER_DURATION * ((int) aecOutFormat.getSampleRate()) / 1000);
				long iMediaBuffer = MediaBuffer_alloc(outFrameSize * outFrames);

				if (iMediaBuffer == 0)
					throw new OutOfMemoryError("MediaBuffer_alloc");
				try {
					long dmoOutputDataBuffer = DMO_OUTPUT_DATA_BUFFER_alloc(iMediaBuffer,
					/* dwStatus */0,
					/* rtTimestamp */0,
					/* rtTimelength */0);
					...
					try {
						bufferMaxLength = IMediaBuffer_GetMaxLength(iMediaBuffer);
	 ...
	 * 
	 * @param iMediaObject
	 *            the <tt>IMediaObject</tt> interface to the Voice Capture DSP
	...
	private void initializeAECInFilterMode(long iMediaObject, AudioFormat inFormat0, AudioFormat inFormat1) throws Exception {
		...
		int hresult = IMediaObject_SetXXXputType(iMediaObject,
		/* IMediaObject_SetInputType */true, dwInputStreamIndex, inFormat0,
		/* dwFlags */0);
		...
		hresult = IMediaObject_SetXXXputType(iMediaObject,
		/* IMediaObject_SetInputType */true, dwInputStreamIndex, inFormat1,
		/* dwFlags */0);
		if (FAILED(hresult)) {
			throw new HResultException(hresult, "IMediaObject_SetInputType, dwInputStreamIndex " + dwInputStreamIndex + ", " + inFormat1);
		}

		long captureIMediaBuffer = MediaBuffer_alloc(capture.bufferSize);
		...
		try {
			 ...
			 * selected "none" for the playback/render endpoint device.
			 */
			long renderIMediaBuffer = MediaBuffer_alloc(((render == null) ? capture : render).bufferSize);

			if (renderIMediaBuffer == 0)
				throw new OutOfMemoryError("MediaBuffer_alloc");
			try {
				captureBufferMaxLength = IMediaBuffer_GetMaxLength(captureIMediaBuffer);
				renderBufferMaxLength = IMediaBuffer_GetMaxLength(renderIMediaBuffer);
				 ...
				 */
				{
					...
					captureNanosPerByte = (8d * 1000d * 1000d * 1000d) / (sampleRate * sampleSizeInBits * channels);
				}
				/*
				 ...
				 */
				{
					 ...
					 * device.
					 */
					AudioFormat af = ((render == null) ? capture : render).outFormat;
					double sampleRate = af.getSampleRate();
					int sampleSizeInBits = af.getSampleSizeInBits();
					int channels = af.getChannels();

					renderBytesPerNano = (sampleRate * sampleSizeInBits * channels) / (8d * 1000d * 1000d * 1000d);
				}
			} finally {
				if (renderIMediaBuffer != 0)
	 ...
	 * 
	 * @param iPropertyStore
	 *            the <tt>IPropertyStore</tt> interface to the Voice Capture DSP
	 *            to be initialized in source mode
	 * @param captureDevice
	 *            <tt>CaptureDeviceInfo2</tt> which identifies the capture
	 *            endpoint device to be used
	 * @param renderDevice
	 *            <tt>CaptureDeviceInfo2</tt> which identifies the render
	 *            endpoint device to be used
	...
	private void initializeAECInSourceMode(long iPropertyStore, CaptureDeviceInfo2 captureDevice, CaptureDeviceInfo2 renderDevice) throws Exception {
		WASAPISystem audioSystem = dataSource.audioSystem;
		int captureDeviceIndex = audioSystem.getIMMDeviceIndex(captureDevice.getLocator().getRemainder(), eCapture);
		...
		int renderDeviceIndex = audioSystem.getIMMDeviceIndex(renderLocator.getRemainder(), eRender);
		...
		int hresult = IPropertyStore_SetValue(iPropertyStore, MFPKEY_WMAAECMA_DEVICE_INDEXES, ((0x0000ffff & captureDeviceIndex)) | ((0x0000ffff & renderDeviceIndex) << 16));
	 ...
	 * @param format
	 *            the <tt>AudioFormat</tt> of the media to be read from the
	 *            specified capture endpoint device
	 * @throws Exception
	 *             if the initialization of the delivery of audio samples from
	 *             the specified capture endpoint into this instance fails
	 */
	private void initializeCapture(MediaLocator locator, AudioFormat format) throws Exception {
		long hnsBufferDuration = aec ? Format.NOT_SPECIFIED : WASAPISystem.DEFAULT_BUFFER_DURATION;
		/*
		...
		capture = new AudioCaptureClient(dataSource.audioSystem, locator, AudioSystem.DataFlow.CAPTURE,
		/* streamFlags */0, hnsBufferDuration, captureFormat, transferHandler);
	 ...
	 * @throws Exception
	 *             if the initialization of the delivery of audio samples from
	 *             the specified render endpoint into this instance for the
	 *             purposes of acoustic echo cancellation (AEC) fails
	 */
	private void initializeRender(MediaLocator locator, AudioFormat format) throws Exception {
		...
		render = new AudioCaptureClient(dataSource.audioSystem, locator, AudioSystem.DataFlow.PLAYBACK, WASAPI.AUDCLNT_STREAMFLAGS_LOOPBACK, WASAPISystem.DEFAULT_BUFFER_DURATION, format, transferHandler);
	 ...
	 * 
	 * @param length
	 *            the number of bytes to pop from <tt>processed</tt>
	 */
	private void popFromProcessed(int length) {
		processedLength = WASAPIRenderer.pop(processed, processedLength, length);
	}
	 ...
	 *            the zero-based index of the input stream on
	 *            <tt>iMediaObject</tt> to which audio samples are to be
	 *            delivered
	 * @param maxLength
	 *            the maximum number of bytes to the delivered through the
	 *            specified input stream. Ignored if negative or greater than
	 *            the actual capacity/maximum length of the
	 *            <tt>IMediaBuffer</tt> associated with the specified
	...
	private void processInput(int dwInputStreamIndex, int maxLength) {
		...
		do {
			...
			try {
				synchronized (iMediaObjectLock) {
					if (iMediaObject != 0) {
						dwFlags = IMediaObject_GetInputStatus(iMediaObject, dwInputStreamIndex);
					} else {
						dwFlags = 0;
			...
			if ((dwFlags & DMO_INPUT_STATUSF_ACCEPT_DATA) == DMO_INPUT_STATUSF_ACCEPT_DATA) {
				/*
				...
				if (toRead > 0) {
					...
					try {
						...
						if ((dwInputStreamIndex == RENDER_INPUT_STREAM_INDEX) && (read == 0))
							replenishRender = true;
					} catch (IOException ioe) {
				...
				if (dwInputStreamIndex == RENDER_INPUT_STREAM_INDEX) {
					...
					if (silence > 0) {
						if ((processInputBuffer == null) || (processInputBuffer.length < silence))
							processInputBuffer = new byte[silence];
						Arrays.fill(processInputBuffer, 0, silence, (byte) 0);
						maybeMediaBufferPush(pBuffer, processInputBuffer, 0, silence);
					}
				}
				...
				try {
					synchronized (iMediaObjectLock) {
						if (iMediaObject != 0) {
							hresult = IMediaObject_ProcessInput(iMediaObject, dwInputStreamIndex, pBuffer,
							/* dwFlags */0,
							/* rtTimestamp */0,
							/* rtTimelength */0);
						} else {
	...
	private void processOutput() {
		...
		do {
			try {
				synchronized (iMediaObjectLock) {
					if (iMediaObject != 0) {
						IMediaObject_ProcessOutput(iMediaObject,
						/* dwFlags */0, 1, dmoOutputDataBuffer);
			...
			try {
				...
				logger.error("Failed to read from acoustic echo cancellation (AEC)" + " output IMediaBuffer.", hre);
				break;
			}
	 ...
	 * 
	 * @param ev
	 *            the <tt>PropertyChangeEvent</tt> to notify this instance about
	 */
	private synchronized void propertyChange(PropertyChangeEvent ev) throws Exception {
		...
		if (DeviceSystem.PROP_DEVICES.equals(propertyName)) {
			 ...
			 */
			if ((oldRenderDevice == null) ? (newRenderDevice == null) : oldRenderDevice.equals(newRenderDevice)) {
				int oldRenderDeviceIndex = this.renderDeviceIndex;
				int newRenderDeviceIndex = (newRenderDevice == null) ? -1 : audioSystem.getIMMDeviceIndex(newRenderDevice.getRemainder(), eRender);
	...
	public void read(Buffer buffer) throws IOException {
		...
		if (resampler == null) {
			...
			if (process == PlugIn.BUFFER_PROCESSED_FAILED) {
				throw new IOException("Failed to resample from [" + effectiveFormat + "] into [" + format + "].");
			}
		}
	}
	 ...
	 *         made available audio samples to be read out of this instance;
		...
		do {
			...
			if (sourceMode) {
				...
				if (captureLength < captureMaxLength)
					...
					int renderMaxLength = computeRenderLength(computeCaptureDuration(captureLength));
			...
			if (!flush) {
				...
				if ((transferHandler != null) && (processedLength >= bufferMaxLength))
		...
		try {
			...
			do {
				...
				synchronized (this) {
					 ...
					 * We explicitly want to support the case in which the user
					 * has selected "none" for the playback/render endpoint
					 * device. Otherwise, we could have added a check (render ==
					 * null).
					 */
					boolean connected = (capture != null) || sourceMode;
				...
				if (transferHandler != null) {
					try {
						...
						if (t instanceof ThreadDeath)
							...
							logger.error("BufferTransferHandler.transferData", t);
						}
					}
				}
	 ...
	 * 
	 * @param locator
	 *            a <tt>MediaLocator</tt> which identifies the audio endpoint
	 *            device this <tt>SourceStream</tt> is to capture data from
	 * @throws IOException
	...
	public synchronized void start() throws IOException {
		 ...
		 */
		if (aec && ((capture != null) || sourceMode) && (processThread == null)) {
			/*
			...
			processThread = new Thread(WASAPIStream.class + ".processThread") {
				@Override
				public void run() {
