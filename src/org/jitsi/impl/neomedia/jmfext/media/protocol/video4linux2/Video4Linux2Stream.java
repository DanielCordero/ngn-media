...
public class Video4Linux2Stream extends AbstractVideoPullBufferStream<DataSource> {
	 ...
	 *         Linux Two API Specification device represented by the <tt>fd</tt>
	 *         of this instance
	 */
	 ...
	 * 
	 * @throws IOException
	 *             if anything goes wrong while negotiating the input method
	 *             with the Video for Linux Two API Specification device
	 *             represented by the <tt>fd</tt> of this instance
	 */
	 ...
	 *            <tt>PullBufferStream</tt>
	 * @throws IOException
	 *             if anything goes wrong while setting the file descriptor of
	 *             the Video for Linux Two API Specification device which is to
	 *             be read through this <tt>PullBufferStream</tt>
	 */
	 ...
	 * 
	 * @param format
	 *            the <tt>Format</tt> of the media data to be captured by the
	 *            Video for Linux Two API Specification device represented by
	 *            the <tt>fd</tt> of this instance
	 * @throws IOException
	 *             if anything goes wrong while setting the <tt>Format</tt> of
	 *             the media data to be captured by the Video for Linux Two API
	 *             Specification device represented by the <tt>fd</tt> of this
	 *             instance
	 */
	 ...
	 * 
	 * @param v4l2_format
	 *            native format to set on the Video for Linux Two API
	 ...
	 * @throws IOException
	 *             if anything goes wrong while setting the native format of the
	 *             media data to be captured by the Video for Linux Two API
	 *             Specification device represented by the <tt>fd</tt> of this
	 *             instance
	 */
	...
	public void start() throws IOException {
		 ...
		 * will be weird (shift, not a JPEG for JPEG/MJPEG format, ...) if it is
		 * done here. Maybe it is due because sometime JMF do the sequence
		 * start/stop/start too quickly...
		 */
		startInRead = true;
	}
