...
public class HResultException extends Exception {
	 ...
	 * 
	 * @param hresult
	 *            the <tt>HRESULT</tt> value to be represented by the new
	 *            instance
	 */
	...
	/**
	 * Returns a <tt>String</tt> representation of a specific <tt>HRESULT</tt>
	 * value.
	 * 
	 * @param hresult
	 *            the <tt>HRESULT</tt> value of which a <tt>String</tt>
