...
public abstract class AbstractPullBufferCaptureDevice extends PullBufferDataSource implements CaptureDevice {
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>PullBufferStream</tt> in the
	 ...
	 *         <tt>PullBufferDataSource</tt> and which has its <tt>Format</tt>
	 ...
	 */
	public CaptureDeviceInfo getCaptureDeviceInfo() {
		return (deviceInfo == null) ? AbstractBufferCaptureDevice.getCaptureDeviceInfo(this) : deviceInfo;
	}
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>PullBufferStream</tt> for
	...
	/**
	 * Sets a specific <tt>CaptureDeviceInfo</tt> on this <tt>CaptureDevice</tt>
	 * .
	 * 
	 * @param deviceInfo
	 *            the <tt>CaptureDeviceInfo</tt> on this <tt>CaptureDevice</tt>
	 */
	 ...
	 *         of the <tt>PullBufferStream</tt> at the specified
	 *         <tt>streamIndex</tt> in the list of streams of this
	 *         <tt>PullBufferStream</tt> or <tt>null</tt> if the attempt to set
