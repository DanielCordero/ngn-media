...
public class Video4Linux2 {
	...
	public static native long mmap(long start, int length, int prot, int flags, int fd, long offset);
	...
	public static native void v4l2_buffer_setIndex(long v4l2_buffer, int index);

	public static native void v4l2_buffer_setMemory(long v4l2_buffer, int memory);

	public static native long v4l2_buf_type_alloc(int type);

	public static native long v4l2_capability_alloc();

	public static native int v4l2_capability_getCapabilities(long v4l2_capability);

	public static native String v4l2_capability_getCard(long v4l2_capability);
	...
	public static native int v4l2_pix_format_getHeight(long v4l2_pix_format);

	public static native int v4l2_pix_format_getPixelformat(long v4l2_pix_format);

	public static native int v4l2_pix_format_getWidth(long v4l2_pix_format);

	public static native void v4l2_pix_format_setBytesperline(long v4l2_pix_format, int bytesperline);

	public static native void v4l2_pix_format_setField(long v4l2_pix_format, int field);

	public static native void v4l2_pix_format_setPixelformat(long v4l2_pix_format, int pixelformat);

	public static native void v4l2_pix_format_setWidthAndHeight(long v4l2_pix_format, int width, int height);

	public static native long v4l2_requestbuffers_alloc(int type);

	public static native int v4l2_requestbuffers_getCount(long v4l2_requestbuffers);

	public static native void v4l2_requestbuffers_setCount(long v4l2_requestbuffers, int count);

	public static native void v4l2_requestbuffers_setMemory(long v4l2_requestbuffers, int memory);
