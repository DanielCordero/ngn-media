...
abstract class AbstractBufferStream<T extends DataSource> extends AbstractControls implements SourceStream {
	 ...
	 *         <tt>AbstractBufferStream</tt> does not directly know its
	 *         <tt>Format</tt> and it relies on the <tt>DataSource</tt> which
	 *         created it to report its <tt>Format</tt>
	 */
	 ...
	 * <tt>AbstractBufferStream</tt> (in contract to setting it before the
	 * <tt>AbstractBufferStream</tt> is created by the <tt>DataSource</tt> which
	 * will provide it).
	 * 
	 * @param format
	 *            the <tt>Format</tt> to be set as the format of this
	 ...
	 *         succeed and any last-known <tt>Format</tt> is to be left in
	 *         effect
	 */
	 ...
	 *         <tt>SourceStream</tt> if it is known; otherwise,
	 *         <tt>LENGTH_UKNOWN</tt>
	 */
	 ...
	 *             data from this <tt>AbstractBufferStream</tt>
	 */
