...
public class WASAPI {
	...
	public static final int CLSCTX_ALL = /* CLSCTX_INPROC_SERVER */0x1 | /* CLSCTX_INPROC_HANDLER */0x2 | /* CLSCTX_LOCAL_SERVER */0x4 | /* CLSCTX_REMOTE_SERVER */0x10;
	...
	static {
		...
		AUDCLNT_E_NOT_STOPPED = MAKE_HRESULT(SEVERITY_ERROR, FACILIY_AUDCLNT, 5);
	...
	public static native void CloseHandle(long hObject) throws HResultException;

	public static native String CoCreateGuid() throws HResultException;

	public static native long CoCreateInstance(String clsid, long pUnkOuter, int dwClsContext, String iid) throws HResultException;
	...
	public static native long CreateEvent(long lpEventAttributes, boolean bManualReset, boolean bInitialState, String lpName) throws HResultException;
	...
	public static native int IAudioCaptureClient_GetNextPacketSize(long thiz) throws HResultException;
	...
	public static native int IAudioClient_GetBufferSize(long thiz) throws HResultException;

	public static native int IAudioClient_GetCurrentPadding(long thiz) throws HResultException;

	public static native long IAudioClient_GetDefaultDevicePeriod(long thiz) throws HResultException;

	public static native long IAudioClient_GetMinimumDevicePeriod(long thiz) throws HResultException;

	public static native long IAudioClient_GetService(long thiz, String iid) throws HResultException;
	...
	public static native long IAudioClient_IsFormatSupported(long thiz, int shareMode, long pFormat) throws HResultException;

	public static native void IAudioClient_Release(long thiz);

	public static native void IAudioClient_SetEventHandle(long thiz, long eventHandle) throws HResultException;

	public static native int IAudioClient_Start(long thiz) throws HResultException;
	 ...
	 */
	public static native int IAudioRenderClient_Write(long thiz, byte[] data, int offset, int length, int srcSampleSize, int srcChannels, int dstSampleSize, int dstChannels) throws HResultException;
	...
	public static native long IMMDevice_QueryInterface(long thiz, String iid) throws HResultException;

	public static native void IMMDevice_Release(long thiz);

	public static native int IMMDeviceCollection_GetCount(long thiz) throws HResultException;
	...
	public static native long IMMDeviceEnumerator_EnumAudioEndpoints(long thiz, int dataFlow, int dwStateMask) throws HResultException;

	public static native long IMMDeviceEnumerator_GetDevice(long thiz, String pwstrId) throws HResultException;

	public static native void IMMDeviceEnumerator_Release(long thiz);

	public static native int IMMEndpoint_GetDataFlow(long thiz) throws HResultException;

	public static native void IMMEndpoint_Release(long thiz);

	public static native String IPropertyStore_GetString(long thiz, long key) throws HResultException;
	...
	public static native long PSPropertyKeyFromString(String pszString) throws HResultException;
	 ...
	 */
	public static native int WaitForSingleObject(long hHandle, long dwMilliseconds) throws HResultException;

	public static native long WAVEFORMATEX_alloc();

	public static native void WAVEFORMATEX_fill(long thiz, char wFormatTag, char nChannels, int nSamplesPerSec, int nAvgBytesPerSec, char nBlockAlign, char wBitsPerSample, char cbSize);
	...
	public static native void WAVEFORMATEX_setNAvgBytesPerSec(long thiz, int nAvgBytesPerSec);

	public static native void WAVEFORMATEX_setNBlockAlign(long thiz, char nBlockAlign);

	public static native void WAVEFORMATEX_setNChannels(long thiz, char nChannels);

	public static native void WAVEFORMATEX_setNSamplesPerSec(long thiz, int nSamplesPerSec);

	public static native void WAVEFORMATEX_setWBitsPerSample(long thiz, char wBitsPerSample);

	public static native void WAVEFORMATEX_setWFormatTag(long thiz, char wFormatTag);
