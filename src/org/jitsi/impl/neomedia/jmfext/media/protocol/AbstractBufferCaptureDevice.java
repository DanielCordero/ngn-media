 ...
 * 
 * @param <AbstractBufferStreamT>
 *            the type of <tt>AbstractBufferStream</tt> through which this
 *            <tt>AbstractBufferCaptureDevice</tt> is to give access to its
 *            media data
 * 
...
public abstract class AbstractBufferCaptureDevice<AbstractBufferStreamT extends AbstractBufferStream<?>> implements CaptureDevice, Controls {
	 ...
	 * 
	 * @throws IOException
	 *             if anything goes wrong while opening the connection to the
	 *             media source of this <tt>AbstractBufferCaptureDevice</tt>
	 */
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>PushBufferStream</tt> in the
	 *            list of streams of this <tt>PushBufferDataSource</tt> which is
	 *            to be associated with the new <tt>FormatControl</tt> instance
	 * @return a new <tt>FormatControl</tt> instance which is to be associated
	 *         with a <tt>PushBufferStream</tt> at the specified
	...
	protected FormatControl createFormatControl(final int streamIndex) {
		return new AbstractFormatControl() {
			...
			/**
			 * Gets the <tt>Format</tt> of the media data of the owner of this
			 * <tt>FormatControl</tt>.
			 * 
			...
			/**
			 * Implements {@link FormatControl#setFormat(Format)}. Attempts to
			 * set the <tt>Format</tt> in which the owner of this
			 * <tt>FormatControl</tt> is to provide media data.
			 * 
			 * @param format
			 *            the <tt>Format</tt> to be set on this instance
			 * @return the currently set <tt>Format</tt> after the attempt to
			 *         set it on this instance if <tt>format</tt> is supported
			 *         by this instance and regardless of whether it was
			 *         actually set; <tt>null</tt> if <tt>format</tt> is not
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>AbstractBufferStream</tt> in
	 *            the list of streams of this
	 *            <tt>AbstractBufferCaptureDevice</tt>
	 * @param formatControl
	 ...
	 *             data from this <tt>AbstractBufferCaptureDevice</tt>
	 * @see #doStart()
	 */
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>AbstractBufferStream</tt> the
	 *            <tt>Format</tt> of which is to be retrieved
	 * @param oldValue
	 *            the last-known <tt>Format</tt> for the
	 *            <tt>AbstractBufferStream</tt> at the specified
	 *            <tt>streamIndex</tt>
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>AbstractBufferStream</tt> for
	 *            which the specified <tt>FormatControl</tt> is to report the
	 ...
	 * 
	 * @param captureDevice
	 *            the <tt>CaptureDevice</tt> to gets the
	 ...
	 * 
	 * @param controlType
	 *            the type of the control available for this instance to be
	 *            retrieved
	 * @return an <tt>Object</tt> which represents the control of the specified
	 *         type available for this instance if such a control is indeed
	 ...
	 * @param oldValue
	 *            the last-known <tt>Format</tt> for the
	 *            <tt>PushBufferStream</tt> at the specified
	 *            <tt>streamIndex</tt>
	 * @return the <tt>Format</tt> to be reported by the <tt>FormatControl</tt>
	 *         of the <tt>PushBufferStream</tt> at the specified
	 *         <tt>streamIndex</tt> in the list of streams of this
	 *         <tt>PushBufferDataSource</tt>.
	 */
	 ...
	 * 
	 * @param <SourceStreamT>
	 *            the type of <tt>SourceStream</tt> which is to be the element
	 *            type of the returned array
	 * @param clz
	 *            the <tt>Class</tt> of <tt>SourceStream</tt> which is to be the
	 *            element type of the returned array
	 * @return an array of the <tt>SourceStream</tt>s through which this
	 *         <tt>AbstractBufferCaptureDevice</tt> gives access to its media
	 *         data
	 */
	 ...
	 * 
	 * @param streamIndex
	 *            the zero-based index of the <tt>PushBufferStream</tt> the
	 *            <tt>Format</tt> of which is to be retrieved
	 * @param oldValue
	 *            the last-known <tt>Format</tt> for the
	 *            <tt>PushBufferStream</tt> at the specified
	...
	private FrameRateControl[] internalGetFrameRateControls() {
		synchronized (controlsSyncRoot) {
			if (frameRateControls == null) {
				...
				frameRateControls = (frameRateControl == null) ? new FrameRateControl[0] : new FrameRateControl[] { frameRateControl };
			}
	 ...
	 * @param streamIndex
	 *            the zero-based index of the <tt>PushBufferStream</tt> the
	 *            <tt>Format</tt> of which is to be set
	 * @param oldValue
	 *            the last-known <tt>Format</tt> for the
	 *            <tt>PushBufferStream</tt> at the specified
	 *            <tt>streamIndex</tt>
	 ...
	 *         of the <tt>PushBufferStream</tt> at the specified
	 *         <tt>streamIndex</tt> in the list of streams of this
	 *         <tt>PushBufferStream</tt> or <tt>null</tt> if the attempt to set
	 *         the <tt>Format</tt> did not success and any last-known
	 *         <tt>Format</tt> is to be left in effect
	 */
	 ...
	 *         of the <tt>AbstractBufferStream</tt> at the specified
	 *         <tt>streamIndex</tt> in the list of streams of this
	 *         <tt>AbstractBufferStream</tt> or <tt>null</tt> if the attempt to
	 *         set the <tt>Format</tt> did not success and any last-known
	 *         <tt>Format</tt> is to be left in effect
	 */
	 ...
	 *         which this <tt>AbstractBufferCaptureDevice</tt> gives access to
	 *         its media data
	 */
