...
public class DSCaptureDevice {
	...
	public interface ISampleGrabberCB {
		 ...
		 * 
		 * @param a
		 *            pointer to the native <tt>DSCaptureDevice</tt> which is
		 *            the source of the notification
		 * @param ptr
		 *            a pointer to the captured/grabbed video frame i.e. to the
		 *            data of the DirectShow <tt>IMediaSample</tt>
		 * @param length
		 *            the length in bytes of the valid data pointed to by
		 *            <tt>ptr</tt>
		 */
	...
	/**
	 * Empty array with <tt>DSFormat</tt> element type. Explicitly defined in
	 ...
	 * 
	 * @param ptr
	 *            a pointer to a native <tt>DSCaptureDevice</tt> to connect to
	 */
	 ...
	 * 
	 * @param ptr
	 *            a pointer to a native <tt>DSCaptureDevice</tt> to disconnect
	 *            from
	 */
