...
public class DataSource extends AbstractVideoPullBufferCaptureDevice {
	...
	private String getDeviceName() {
		...
		return ((locator != null) && DeviceSystem.LOCATOR_PROTOCOL_VIDEO4LINUX2.equalsIgnoreCase(locator.getProtocol())) ? locator.getRemainder() : null;
	}
	 ...
	 * 
	 * @param v4l2PixFmt
	 *            the FFmpeg pixel format to get the matching Video for Linux
	 *            Two API Specification pixel format of
	 ...
	 * 
	 * @param ffmpegPixFmt
	 *            the Video for Linux Two API Specification pixel format to get
	 *            the matching FFmpeg pixel format of
