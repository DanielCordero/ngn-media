...
public class ByteBufferPool {
	 ...
	 * 
	 * @param capacity
	 *            the minimal number of bytes that the returned
	 *            <tt>ByteBuffer</tt> is to be capable of receiving
	 * @return a <tt>ByteBuffer</tt> which is ready for writing captured media
	 *         data into and which is capable of receiving at least
	 *         <tt>capacity</tt> number of bytes
	 */
	 ...
	 * <tt>ByteBufferPool</tt> in order to reduce the numbers of allocations and
	 * deallocations of <tt>ByteBuffer</tt>s and their respective native memory.
	 */
