...
public class RTPSessionMgr extends net.sf.fmj.media.rtp.RTPSessionMgr {
	 ...
	 *         <tt>null</tt> if this instance employs internal logic to generate
	...
	protected long generateSSRC(GenerateSSRCCause cause) {
		...
		return (ssrcFactory == null) ? super.generateSSRC(cause) : ssrcFactory.generateSSRC((cause == null) ? null : cause.name());
	}
	 ...
	 * 
	 * @param ssrcFactory
	 *            the <tt>SSRCFactory</tt> to be utilized by this instance to
	 *            generate new synchronization source (SSRC) identifiers or
	 *            <tt>null</tt> if this instance is to employ internal logic to
