...
public class JAWTRendererVideoComponent extends Canvas {
	 ...
	 * <tt>Component</tt>, it may be able to determine when the native handle
	 * needs painting without waiting for AWT to call <tt>paint</tt> on the
	 * <tt>Component</tt>. In such a scenario, the native counterpart may
	...
	/**
	 * Gets the handle of the native counterpart of the <tt>JAWTRenderer</tt>
	 * which paints in this <tt>AWTVideoComponent</tt>.
	 * 
	 * @return the handle of the native counterpart of the <tt>JAWTRenderer</tt>
	 *         which paints in this <tt>AWTVideoComponent</tt>
	 */
