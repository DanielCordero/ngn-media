 ...
 * 
 * @param <T>
 *            the runtime type of the <tt>AudioSystem</tt> which provides the
...
public abstract class AbstractAudioRenderer<T extends AudioSystem> extends AbstractRenderer<AudioFormat> {
	 ...
	 * 
	 * @param audioSystem
	 *            the <tt>AudioSystem</tt> which is to provide the playback
	 *            devices to be used by the new instance
	 */
	 ...
	 * 
	 * @param audioSystem
	 *            the <tt>AudioSystem</tt> which is to provide the notification
	 *            or playback devices to be used by the new instance
	 * @param dataFlow
	 *            the flow of the media data to be implemented by the new
	 *            instance i.e. whether notification or playback devices
	 *            provided by the specified <tt>audioSystem</tt> are to be used
	 *            by the new instance. Must be either
	 *            {@link AudioSystem.DataFlow#NOTIFY} or
	 *            {@link AudioSystem.DataFlow#PLAYBACK}.
	 * @throws IllegalArgumentException
	 *             if the specified <tt>dataFlow</tt> is neither
	 *             <tt>AudioSystem.DataFlow.NOTIFY</tt> nor
	 ...
	 *            <tt>CaptureDeviceInfo</tt> registered by the
	 *            <tt>AudioSystem</tt> which is to provide the playback devices
	 *            to be used by the new instance
	 */
	 ...
	 *            the protocol of the <tt>MediaLocator</tt>s of the
	 *            <tt>CaptureDeviceInfo</tt> registered by the
	 *            <tt>AudioSystem</tt> which is to provide the notification or
	 ...
	 * 
	 * @param locator
	 *            the <tt>MediaLocator</tt> which specifies the playback device
	 *            to be used by this <tt>Renderer</tt>
	 */
	 ...
	 * 
	 * @param volumeControl
	 *            the <tt>VolumeControl</tt> which is to control the volume
	 *            (level) of the audio (to be) played back by this
	 *            <tt>Renderer</tt>
	 */
