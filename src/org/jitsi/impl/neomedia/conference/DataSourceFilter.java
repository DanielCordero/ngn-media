...
public interface DataSourceFilter {
	 ...
	 * 
	 * @param dataSource
	 *            the <tt>DataSource</tt> to be checked whether it is accepted
	 *            by this filter
	 * @return <tt>true</tt> if this filter accepts the specified
	 *         <tt>DataSource</tt> i.e. if the caller of this filter should
	 *         include it in its selection; otherwise, <tt>false</tt>
	 */
