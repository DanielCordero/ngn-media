    ...
    implements TransformEngine
{
                ...
                ReceiveStream receiveStream)
    {
        ...
        RTPMediaFormat mediaFormat = mediaStream.getFormat();
        ...
        if (mediaFormat != null)
        {
            ...
            if (encoding != null)
            {
                ...
                if (AudioFormat.OPUS_RTP.toLowerCase().contains(encoding)
                        || AudioFormat.SILK_RTP.toLowerCase().contains(encoding))
                {
