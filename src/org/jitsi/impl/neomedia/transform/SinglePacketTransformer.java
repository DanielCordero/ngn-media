...
/**
 * Extends the <tt>PacketTransformer</tt> interface with methods which allow the
 * transformation of a single packet into a single packet.
 * 
...
public abstract class SinglePacketTransformer implements PacketTransformer {
	...
	/**
	 * {@inheritDoc} Reverse-transforms an array of packets by calling
