...
public abstract class TransformInputStream<T> extends RTPConnectorInputStream<T> {
	 ...
	 * <tt>DatagramPacket</tt> in order to have this instance receive its packet
	 * data through its {@link #read(byte[], int, int)} method.
	 ...
	 *         <tt>DatagramPacket</tt> and not make it available to this
	 *         instance through its {@link #read(byte[], int, int)} method
