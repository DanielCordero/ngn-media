 ...
 * @author Boris Grozev
 */
public class AbsSendTimeEngine extends SinglePacketTransformer implements TransformEngine {
	/**
	 * One billion.
	 */
	...
	public RawPacket transform(RawPacket pkt) {
		if (extensionID != -1 && pkt.getExtensionBit()) {
	 ...
	 * in <tt>pkt</tt> and tries to replace its timestamp with one generated
	 * locally (based on {@link System#nanoTime()}.
	 * 
	 * @param pkt
	 *            the packet to work on.
	 */
	 ...
	 * 
	 * @param buf
	 *            the buffer where to write the timestamp.
	 * @param off
	 *            the offset at which to write the timestamp.
	 */
