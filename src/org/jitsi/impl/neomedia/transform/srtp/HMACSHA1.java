...
public class HMACSHA1 {
	 ...
	 *         implements a keyed-hash message authentication code (HMAC) with
	 *         SHA-1
	 */
		...
		if (useOpenSSL) {
			try {
				...
				if (t instanceof InterruptedException) {
					...
					logger.warn("Failed to employ OpenSSL (Crypto) for an optimized" + " HMAC-SHA1 implementation: " + t.getLocalizedMessage());
				}
			}
		}
