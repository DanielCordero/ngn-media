...
public class AES {
	 ...
	 * implementations.
	 */
	private static final Class<?>[] FACTORY_CLASSES = { BouncyCastleBlockCipherFactory.class, OpenSSLBlockCipherFactory.class, SunJCEBlockCipherFactory.class, SunPKCS11BlockCipherFactory.class, };
	 ...
	 * @author Lyubomir Marinov
	 */
	public static class OpenSSLBlockCipherFactory implements BlockCipherFactory {
		/**
		 * {@inheritDoc}
		 */
		@Override
