...
/**
 * SRTCPTransformer implements PacketTransformer. It encapsulate the encryption
 * / decryption logic for SRTCP packets
 * 
...
public class SRTCPTransformer extends SinglePacketTransformer {
	 ...
	 * 
	 * @param srtpTransformer
	 *            the <tt>SRTPTransformer</tt> with which this
	 *            <tt>SRTCPTransformer</tt> will share its
	 ...
	 * 
	 * @param factory
	 *            The associated context factory for both transform directions.
	 */
	 ...
	 *            The associated context factory for forward transformations.
	 * @param reverseFactory
	 *            The associated context factory for reverse transformations.
	 */
