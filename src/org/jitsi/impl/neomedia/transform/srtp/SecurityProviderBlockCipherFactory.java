...
public class SecurityProviderBlockCipherFactory implements BlockCipherFactory {
	 ...
	 *            the name of the transformation
	 * @param provider
	 *            the <tt>java.security.Provider</tt> which provides the
	 *            implementations of the <tt>BlockCipher</tt>s to be initialized
	 *            by the new instance
	 */
	 ...
	 *            the name of the transformation
	 * @param provider
	 *            the name of the <tt>java.security.Provider</tt> which provides
	 *            the implementations of the <tt>BlockCipher</tt>s to be
	...
	public BlockCipher createBlockCipher() throws Exception {
		return new BlockCipherAdapter(Cipher.getInstance(transformation, provider));
	}
}
