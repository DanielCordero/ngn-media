 ...
 * 
 * This class extends the RawPacket class and adds some methods required by the
 * ZRTP transformer.
 * 
...
public class ZrtpRawPacket extends RawPacket {
	 ...
	 * 
	 * Initialize this packet and set the ZRTP magic value to mark it as a ZRTP
	 * packet.
	 * 
	 * @param buf
	 *            Byte array holding the content of this Packet
	 * @param off
	 *            Start offset of packet content inside buffer
	 * @param len
	 ...
	 * 
	 * The method checks if the first byte of the received data matches the
	 * defined ZRTP pattern 0x10
	 * 
	...
	/**
	 * Checks whether extension bit is set and if so is the extension header an
	 * zrtp one.
	 * 
	 * @param pkt
	 *            the packet to check.
