...
public class SDesTransformEngine implements SrtpControl.TransformEngine {
	 ...
	 * 
	 * @param inAttribute
	 *            Key material for the incoming stream.
	 * @param outAttribute
	 *            Key material for the outgoing stream.
	 */
	...
	public void update(SrtpCryptoAttribute inAttribute, SrtpCryptoAttribute outAttribute) {
		SRTPContextFactory forwardCtx = getTransformEngine(outAttribute, true /* sender */);
		SRTPContextFactory reverseCtx = getTransformEngine(inAttribute, false /* receiver */);
