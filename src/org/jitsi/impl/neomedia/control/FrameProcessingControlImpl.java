...
public class FrameProcessingControlImpl implements FrameProcessingControl {
	 ...
	 *         <tt>FrameProcessingControl</tt> is to perform only the minimum
	 *         operations necessary to keep it working normally but without
	 *         producing output; otherwise, <tt>false</tt>
	 */
	 ...
	 * 
	 * @param framesBehind
	 *            the number of frames the owner of this
	 ...
	 *            <tt>true</tt> if minimal processing mode is to be turned on or
	 *            <tt>false</tt> if minimal processing mode is to be turned off
