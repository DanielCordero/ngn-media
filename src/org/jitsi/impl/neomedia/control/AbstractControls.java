...
public abstract class AbstractControls implements Controls {
	 ...
	 * 
	 * @param controlsImpl
	 *            the implementation of <tt>Controls</tt> which is to be queried
	 *            for its list of controls so that the control of the specified
	 ...
	 *         <tt>controlsImpl</tt> of the specified <tt>controlType</tt> if
	 *         such a control is made available through
	 ...
	 *         <tt>controlsImpl</tt> or <tt>controlsImpl</tt> is an instance of
	 *         the specified <tt>controlType</tt>; otherwise, <tt>null</tt>
	 */
