...
public class ReadOnlyBufferControlDelegate implements BufferControl {
	 ...
	 * 
	 * @param bufferLength
	 *            the length in milliseconds of the buffering to be performed by
	 *            the owner of the wrapped <tt>BufferControl</tt>
	 * @return the length in milliseconds of the buffering performed by the
	 *         owner of the wrapped <tt>BufferControl</tt> that is actually in
	 *         effect
	 */
	 ...
	 *            the minimum threshold in milliseconds for the buffering to be
	 *            performed by the owner of the wrapped <tt>BufferControl</tt>
	 * @return the minimum threshold in milliseconds for the buffering performed
	 *         by the owner of the wrapped <tt>BufferControl</tt> that is
	 *         actually in effect
	 */
