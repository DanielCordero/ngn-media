...
public abstract class AbstractFormatControl implements FormatControl {
	 ...
	 * 
	 * @param enabled
	 *            <tt>true</tt> if this track is to be enabled; otherwise,
	 *            <tt>false</tt>
	 */
	 ...
	 *         this instance if <tt>format</tt> is supported by this instance
	 *         and regardless of whether it was actually set; <tt>null</tt> if
	 ...
	 * 
	 * @param formatControl
	 *            the <tt>FormatControl</tt> for which the functionality is
	 *            implemented
	 * @param format
	 *            the <tt>Format</tt> specified to be set to
	 *            <tt>formatControl</tt> and which will be ignored in accord
	 *            with the documentation of
	 *            <tt>FormatControl#setFormat(Format)</tt>
	 * @return the currently set <tt>Format</tt> of <tt>formatControl</tt> if
	 *         <tt>format</tt> is supported by <tt>formatControl</tt>;
	 *         <tt>null</tt> if <tt>format</tt> is not supported by
	 *         <tt>formatControl</tt>
	 */
