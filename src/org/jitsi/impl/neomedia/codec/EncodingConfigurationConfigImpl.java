...
public class EncodingConfigurationConfigImpl extends EncodingConfigurationImpl {
	 ...
	 * 
	 * @param prefix
	 *            the prefix to use when loading and storing properties
	 */
	...
	private void loadConfig() {
		...
		for (String pName : configurationService.getPropertyNamesByPrefix(propPrefix, false))
	...
	public void setPriority(RTPMediaFormat encoding, int priority) {
		...
		configurationService.setProperty(propPrefix + "." + getEncodingPreferenceKey(encoding), priority);
	}
}
