...
public class JavaEncoder extends AbstractCodec2 {
	...
	/**
	 * The last input format used by this instance of the encoder. If null we
	 * must create the encoder with the current input format.
	 */
	 ...
	 */
	public JavaEncoder() {
		super("Speex Java Encoder", AudioFormat.class, new Format[] { new AudioFormat(AudioFormat.SPEEX_RTP) });

		inputFormats = new AudioFormat[] { new AudioFormat(AudioFormat.LINEAR, 8000, 16, 1, AudioFormat.LITTLE_ENDIAN, AudioFormat.SIGNED), new AudioFormat(AudioFormat.LINEAR, 16000, 16, 1, AudioFormat.LITTLE_ENDIAN, AudioFormat.SIGNED), new AudioFormat(AudioFormat.LINEAR, 32000, 16, 1, AudioFormat.LITTLE_ENDIAN, AudioFormat.SIGNED) };
	}
	...
	protected Format[] getMatchingOutputFormats(Format in) {
		...
		return new Format[] { new AudioFormat(AudioFormat.SPEEX_RTP, af.getSampleRate(), af.getSampleSizeInBits(), af.getChannels(), af.getEndian(), af.getSigned()) };
	}
