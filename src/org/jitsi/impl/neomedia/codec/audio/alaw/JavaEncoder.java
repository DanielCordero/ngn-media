...
public class JavaEncoder extends com.ibm.media.codec.audio.AudioCodec {
	 ...
	 */
	public JavaEncoder() {
		supportedInputFormats = new AudioFormat[] { new AudioFormat(AudioFormat.LINEAR, Format.NOT_SPECIFIED, 16, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED), new AudioFormat(AudioFormat.LINEAR, Format.NOT_SPECIFIED, 8, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED) }; // support
																																																																					// 1
																																																																					// channel
																																																																					// and
																																																																					// 8/16
	 ...
	 *             if open failed (which cannot happend for this codec since no
	 *             resources are to be opened)
	 */
	@Override
	...
	public int process(Buffer inputBuffer, Buffer outputBuffer) {
		...
		aLawEncode(bigEndian, inpData, inputBuffer.getOffset(), inputBuffer.getLength(), outData);
