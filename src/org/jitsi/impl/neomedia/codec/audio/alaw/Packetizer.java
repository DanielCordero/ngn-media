...
public class Packetizer extends com.ibm.media.codec.audio.AudioPacketizer {
	 ...
	 */
	public Packetizer() {
		defaultOutputFormats = new AudioFormat[] { new AudioFormat(AudioFormat.ALAW_RTP, Format.NOT_SPECIFIED, 8, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, 8, Format.NOT_SPECIFIED, Format.byteArray) };
		packetSize = 160;
	...
	protected Format[] getMatchingOutputFormats(Format in) {
		...
		supportedOutputFormats = new AudioFormat[] { new AudioFormat(AudioFormat.ALAW_RTP, sampleRate, 8, 1, Format.NOT_SPECIFIED, Format.NOT_SPECIFIED, 8, sampleRate, Format.byteArray) };
