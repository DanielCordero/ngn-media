...
public class PortAudioException extends Exception {
	 ...
	 *         {@link Pa#paNoError} if it is not known
	 */
	 ...
	 *         (detailed) message represented by this instance; otherwise,
	 *         <tt>null</tt>
	 */
	...
	public String toString() {
		...
		String errorCodeStr = (errorCode == Pa.paNoError) ? null : Long.toString(errorCode);
