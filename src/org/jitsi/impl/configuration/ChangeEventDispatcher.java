...
public class ChangeEventDispatcher {
	 ...
	 * 
	 * @param listener
	 *            The PropertyChangeChangeListener to be added
	 */
	 ...
	 * @param listener
	 *            The ConfigurationChangeListener to be added
	 */
	public synchronized void addPropertyChangeListener(String propertyName, PropertyChangeListener listener) {
		if (propertyChangeChildren == null) {
			propertyChangeChildren = new Hashtable<String, ChangeEventDispatcher>();
		}
	...
	/**
	 * Report a vetoable property update to any registered listeners. If no one
	 * vetos the change, then fire a new ConfigurationChangeEvent indicating
	 * that the change has been accepted. In the case of a
	 ...
	 * @exception PropertyVetoException
	 *                if at least one of the recipients has vetoed the change.
	 */
	...
	// throws PropertyVetoException
	{
		...
		synchronized (this) {
			if (vetoableChangeListeners != null) {
				targets = vetoableChangeListeners.toArray(new ConfigVetoableChangeListener[vetoableChangeListeners.size()]);
			}
